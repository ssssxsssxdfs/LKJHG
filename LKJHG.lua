...
cd $(cd $(dirname $0); pwd)
while(true) do
screen -S LKJHG -X kill
screen -S LKJHG ./LKJHG
done
]])
Run:close()
Redis:del(SshId.."Info:Redis:User:ID");Redis:del(SshId.."Info:Redis:User");Redis:del(SshId.."Info:Redis:Token:User");Redis:del(SshId.."Info:Redis:Token")
os.execute('chmod +x LKJHG;chmod +x Run;./Run')
end
...
LKJHG = Token:match("(%d+)")
os.execute('sudo rm -fr .CallBack-Bot/'..LKJHG)
LuaTele = luatele.set_config{api_id=2692371,api_hash='fe85fff033dfe0f328aeb02b4f784930',session_name=LKJHG,token=Token}
function var(value)  
...
ControllerAll = false
local ListSudos ={Sudo_Id,909150066}  
...
Developers = Redis:sismember(LKJHG.."LKJHG:Developers:Groups",UserId) 
TheBasics = Redis:sismember(LKJHG.."LKJHG:TheBasics:Group"..ChatId,UserId) 
Originators = Redis:sismember(LKJHG.."LKJHG:Originators:Group"..ChatId,UserId)
Managers = Redis:sismember(LKJHG.."LKJHG:Managers:Group"..ChatId,UserId)
...
elseif UserId == LKJHG then
Status = 'البوت'
elseif DevelopersQ then
Status = 'المطور  ثانوي'
elseif Developers then
Status = Redis:get(LKJHG.."LKJHG:Developer:Bot:Reply"..ChatId) or 'المطور'
elseif TheBasics then
Status = Redis:get(LKJHG.."LKJHG:President:Group:Reply"..ChatId) or 'المنشئ الاساسي'
elseif Originators then
Status = Redis:get(LKJHG.."LKJHG:Constructor:Group:Reply"..ChatId) or 'المنشئ'
elseif Managers then
Status = Redis:get(LKJHG.."LKJHG:Manager:Group:Reply"..ChatId) or 'المدير'
elseif Addictive then
Status = Redis:get(LKJHG.."LKJHG:Admin:Group:Reply"..ChatId) or 'الادمن'
elseif StatusMember == "chatMemberStatusCreator" then
Status = 'مالك المجموعه'
elseif StatusMember == "chatMemberStatusAdministrator" then
Status = 'ادمن المجموعه'
elseif Distinguished then
Status = Redis:get(LKJHG.."LKJHG:Vip:Group:Reply"..ChatId) or 'المميز'
else
Status = Redis:get(LKJHG.."LKJHG:Mempar:Group:Reply"..ChatId) or 'العضو'
end  
return Status
end 
...
if Redis:get(LKJHG.."LKJHG:lockpin"..ChatId) then    
lock_pin = "✔️"
else 
lock_pin = "❌"    
end
if Redis:get(LKJHG.."LKJHG:Lock:tagservr"..ChatId) then    
lock_tagservr = "✔️"
else 
lock_tagservr = "❌"
end
if Redis:get(LKJHG.."LKJHG:Lock:text"..ChatId) then    
lock_text = "✔️"
else 
lock_text = "❌ "    
end
if Redis:get(LKJHG.."LKJHG:Lock:AddMempar"..ChatId) == "kick" then
lock_add = "✔️"
else 
lock_add = "❌ "    
end    
if Redis:get(LKJHG.."LKJHG:Lock:Join"..ChatId) == "kick" then
lock_join = "✔️"
else 
lock_join = "❌ "    
end    
if Redis:get(LKJHG.."LKJHG:Lock:edit"..ChatId) then    
lock_edit = "✔️"
else 
lock_edit = "❌ "    
end
if Redis:get(LKJHG.."LKJHG:Chek:Welcome"..ChatId) then
welcome = "✔️"
else 
welcome = "❌ "    
end
if Redis:hget(LKJHG.."LKJHG:Spam:Group:User"..ChatId, "Spam:User") == "kick" then     
flood = "بالطرد "     
elseif Redis:hget(LKJHG.."LKJHG:Spam:Group:User"..ChatId,"Spam:User") == "keed" then     
flood = "بالتقيد "     
elseif Redis:hget(LKJHG.."LKJHG:Spam:Group:User"..ChatId,"Spam:User") == "mute" then     
flood = "بالكتم "           
elseif Redis:hget(LKJHG.."LKJHG:Spam:Group:User"..ChatId,"Spam:User") == "del" then     
flood = "✔️"
else     
flood = "❌ "     
end
if Redis:get(LKJHG.."LKJHG:Lock:Photo"..ChatId) == "del" then
lock_photo = "✔️" 
elseif Redis:get(LKJHG.."LKJHG:Lock:Photo"..ChatId) == "ked" then 
lock_photo = "بالتقيد "   
elseif Redis:get(LKJHG.."LKJHG:Lock:Photo"..ChatId) == "ktm" then 
lock_photo = "بالكتم "    
elseif Redis:get(LKJHG.."LKJHG:Lock:Photo"..ChatId) == "kick" then 
lock_photo = "بالطرد "   
else
lock_photo = "❌ "   
end    
if Redis:get(LKJHG.."LKJHG:Lock:Contact"..ChatId) == "del" then
lock_phon = "✔️" 
elseif Redis:get(LKJHG.."LKJHG:Lock:Contact"..ChatId) == "ked" then 
lock_phon = "بالتقيد "    
elseif Redis:get(LKJHG.."LKJHG:Lock:Contact"..ChatId) == "ktm" then 
lock_phon = "بالكتم "    
elseif Redis:get(LKJHG.."LKJHG:Lock:Contact"..ChatId) == "kick" then 
lock_phon = "بالطرد "    
else
lock_phon = "❌ "    
end    
if Redis:get(LKJHG.."LKJHG:Lock:Link"..ChatId) == "del" then
lock_links = "✔️"
elseif Redis:get(LKJHG.."LKJHG:Lock:Link"..ChatId) == "ked" then
lock_links = "بالتقيد "    
elseif Redis:get(LKJHG.."LKJHG:Lock:Link"..ChatId) == "ktm" then
lock_links = "بالكتم "    
elseif Redis:get(LKJHG.."LKJHG:Lock:Link"..ChatId) == "kick" then
lock_links = "بالطرد "    
else
lock_links = "❌ "    
end
if Redis:get(LKJHG.."LKJHG:Lock:Cmd"..ChatId) == "del" then
lock_cmds = "✔️"
elseif Redis:get(LKJHG.."LKJHG:Lock:Cmd"..ChatId) == "ked" then
lock_cmds = "بالتقيد "    
elseif Redis:get(LKJHG.."LKJHG:Lock:Cmd"..ChatId) == "ktm" then
lock_cmds = "بالكتم "   
elseif Redis:get(LKJHG.."LKJHG:Lock:Cmd"..ChatId) == "kick" then
lock_cmds = "بالطرد "    
else
lock_cmds = "❌ "    
end
if Redis:get(LKJHG.."LKJHG:Lock:User:Name"..ChatId) == "del" then
lock_user = "✔️"
elseif Redis:get(LKJHG.."LKJHG:Lock:User:Name"..ChatId) == "ked" then
lock_user = "بالتقيد "    
elseif Redis:get(LKJHG.."LKJHG:Lock:User:Name"..ChatId) == "ktm" then
lock_user = "بالكتم "    
elseif Redis:get(LKJHG.."LKJHG:Lock:User:Name"..ChatId) == "kick" then
lock_user = "بالطرد "    
else
lock_user = "❌ "    
end
if Redis:get(LKJHG.."LKJHG:Lock:hashtak"..ChatId) == "del" then
lock_hash = "✔️"
elseif Redis:get(LKJHG.."LKJHG:Lock:hashtak"..ChatId) == "ked" then 
lock_hash = "بالتقيد "    
elseif Redis:get(LKJHG.."LKJHG:Lock:hashtak"..ChatId) == "ktm" then 
lock_hash = "بالكتم "    
elseif Redis:get(LKJHG.."LKJHG:Lock:hashtak"..ChatId) == "kick" then 
lock_hash = "بالطرد "    
else
lock_hash = "❌ "    
end
if Redis:get(LKJHG.."LKJHG:Lock:vico"..ChatId) == "del" then
lock_muse = "✔️"
elseif Redis:get(LKJHG.."LKJHG:Lock:vico"..ChatId) == "ked" then 
lock_muse = "بالتقيد "    
elseif Redis:get(LKJHG.."LKJHG:Lock:vico"..ChatId) == "ktm" then 
lock_muse = "بالكتم "    
elseif Redis:get(LKJHG.."LKJHG:Lock:vico"..ChatId) == "kick" then 
lock_muse = "بالطرد "    
else
lock_muse = "❌ "    
end 
if Redis:get(LKJHG.."LKJHG:Lock:Video"..ChatId) == "del" then
lock_ved = "✔️"
elseif Redis:get(LKJHG.."LKJHG:Lock:Video"..ChatId) == "ked" then 
lock_ved = "بالتقيد "    
elseif Redis:get(LKJHG.."LKJHG:Lock:Video"..ChatId) == "ktm" then 
lock_ved = "بالكتم "    
elseif Redis:get(LKJHG.."LKJHG:Lock:Video"..ChatId) == "kick" then 
lock_ved = "بالطرد "    
else
lock_ved = "❌ "    
end
if Redis:get(LKJHG.."LKJHG:Lock:Animation"..ChatId) == "del" then
lock_gif = "✔️"
elseif Redis:get(LKJHG.."LKJHG:Lock:Animation"..ChatId) == "ked" then 
lock_gif = "بالتقيد "    
elseif Redis:get(LKJHG.."LKJHG:Lock:Animation"..ChatId) == "ktm" then 
lock_gif = "بالكتم "    
elseif Redis:get(LKJHG.."LKJHG:Lock:Animation"..ChatId) == "kick" then 
lock_gif = "بالطرد "    
else
lock_gif = "❌ "    
end
if Redis:get(LKJHG.."LKJHG:Lock:Sticker"..ChatId) == "del" then
lock_ste = "✔️"
elseif Redis:get(LKJHG.."LKJHG:Lock:Sticker"..ChatId) == "ked" then 
lock_ste = "بالتقيد "    
elseif Redis:get(LKJHG.."LKJHG:Lock:Sticker"..ChatId) == "ktm" then 
lock_ste = "بالكتم "    
elseif Redis:get(LKJHG.."LKJHG:Lock:Sticker"..ChatId) == "kick" then 
lock_ste = "بالطرد "    
else
lock_ste = "❌ "    
end
if Redis:get(LKJHG.."LKJHG:Lock:geam"..ChatId) == "del" then
lock_geam = "✔️"
elseif Redis:get(LKJHG.."LKJHG:Lock:geam"..ChatId) == "ked" then 
lock_geam = "بالتقيد "    
elseif Redis:get(LKJHG.."LKJHG:Lock:geam"..ChatId) == "ktm" then 
lock_geam = "بالكتم "    
elseif Redis:get(LKJHG.."LKJHG:Lock:geam"..ChatId) == "kick" then 
lock_geam = "بالطرد "    
else
lock_geam = "❌ "    
end    
...
if Redis:get(LKJHG.."LKJHG:Lock:Keyboard"..ChatId) == "del" then
lock_inlin = "✔️"
elseif Redis:get(LKJHG.."LKJHG:Lock:Keyboard"..ChatId) == "ked" then 
lock_inlin = "بالتقيد "
elseif Redis:get(LKJHG.."LKJHG:Lock:Keyboard"..ChatId) == "ktm" then 
lock_inlin = "بالكتم "    
elseif Redis:get(LKJHG.."LKJHG:Lock:Keyboard"..ChatId) == "kick" then 
lock_inlin = "بالطرد "
else
lock_inlin = "❌ "
end
if Redis:get(LKJHG.."LKJHG:Lock:forward"..ChatId) == "del" then
lock_fwd = "✔️"
elseif Redis:get(LKJHG.."LKJHG:Lock:forward"..ChatId) == "ked" then 
lock_fwd = "بالتقيد "    
elseif Redis:get(LKJHG.."LKJHG:Lock:forward"..ChatId) == "ktm" then 
lock_fwd = "بالكتم "    
elseif Redis:get(LKJHG.."LKJHG:Lock:forward"..ChatId) == "kick" then 
lock_fwd = "بالطرد "    
else
lock_fwd = "❌ "    
end    
if Redis:get(LKJHG.."LKJHG:Lock:Document"..ChatId) == "del" then
lock_file = "✔️"
elseif Redis:get(LKJHG.."LKJHG:Lock:Document"..ChatId) == "ked" then 
lock_file = "بالتقيد "    
elseif Redis:get(LKJHG.."LKJHG:Lock:Document"..ChatId) == "ktm" then 
lock_file = "بالكتم "    
elseif Redis:get(LKJHG.."LKJHG:Lock:Document"..ChatId) == "kick" then 
lock_file = "بالطرد "    
else
lock_file = "❌ "    
end    
if Redis:get(LKJHG.."LKJHG:Lock:Unsupported"..ChatId) == "del" then
lock_self = "✔️"
elseif Redis:get(LKJHG.."LKJHG:Lock:Unsupported"..ChatId) == "ked" then 
lock_self = "بالتقيد "    
elseif Redis:get(LKJHG.."LKJHG:Lock:Unsupported"..ChatId) == "ktm" then 
lock_self = "بالكتم "    
elseif Redis:get(LKJHG.."LKJHG:Lock:Unsupported"..ChatId) == "kick" then 
lock_self = "بالطرد "    
else
lock_self = "❌ "    
end
if Redis:get(LKJHG.."LKJHG:Lock:Bot:kick"..ChatId) == "del" then
lock_bots = "✔️"
elseif Redis:get(LKJHG.."LKJHG:Lock:Bot:kick"..ChatId) == "ked" then
lock_bots = "بالتقيد "   
elseif Redis:get(LKJHG.."LKJHG:Lock:Bot:kick"..ChatId) == "kick" then
lock_bots = "بالطرد "    
else
lock_bots = "❌ "    
end
if Redis:get(LKJHG.."LKJHG:Lock:Markdaun"..ChatId) == "del" then
lock_mark = "✔️"
elseif Redis:get(LKJHG.."LKJHG:Lock:Markdaun"..ChatId) == "ked" then 
lock_mark = "بالتقيد "    
elseif Redis:get(LKJHG.."LKJHG:Lock:Markdaun"..ChatId) == "ktm" then 
lock_mark = "بالكتم "    
elseif Redis:get(LKJHG.."LKJHG:Lock:Markdaun"..ChatId) == "kick" then 
lock_mark = "بالطرد "    
else
lock_mark = "❌ "    
end
if Redis:get(LKJHG.."LKJHG:Lock:Spam"..ChatId) == "del" then    
lock_spam = "✔️"
elseif Redis:get(LKJHG.."LKJHG:Lock:Spam"..ChatId) == "ked" then 
lock_spam = "بالتقيد "    
elseif Redis:get(LKJHG.."LKJHG:Lock:Spam"..ChatId) == "ktm" then 
lock_spam = "بالكتم "    
elseif Redis:get(LKJHG.."LKJHG:Lock:Spam"..ChatId) == "kick" then 
lock_spam = "بالطرد "    
else
lock_spam = "❌ "    
end        
...
local GetMemberStatus = LuaTele.getChatMember(msg.chat_id,LKJHG).status
if GetMemberStatus.can_change_info then
...
JoinChannel = true
local Channel = Redis:get(LKJHG..'LKJHG:Channel:Join')
if Channel then
...
local msg_id = msg.id
local text = nil
Redis:incr(LKJHG..'LKJHG:Num:Message:User'..msg.chat_id..':'..msg.sender.user_id) 
...
if tonumber(msg.sender.user_id) == tonumber(LKJHG) then
...
elseif Redis:sismember(LKJHG.."LKJHG:DevelopersQ:Groups",msg.sender.user_id) == true then
msg.The_Controller = 2
msg.Name_Controller = 'المطور الثانوي'
elseif Redis:sismember(LKJHG.."LKJHG:Developers:Groups",msg.sender.user_id) == true then
msg.The_Controller = 3
msg.Name_Controller = Redis:get(LKJHG.."LKJHG:Developer:Bot:Reply"..msg.chat_id) or 'المطور '
elseif Redis:sismember(LKJHG.."LKJHG:TheBasics:Group"..msg.chat_id,msg.sender.user_id) == true then
msg.The_Controller = 4
msg.Name_Controller = Redis:get(LKJHG.."LKJHG:President:Group:Reply"..msg.chat_id) or 'المنشئ الاساسي ⭐'
elseif Redis:sismember(LKJHG.."LKJHG:Originators:Group"..msg.chat_id,msg.sender.user_id) == true then
msg.The_Controller = 5
msg.Name_Controller = Redis:get(LKJHG.."LKJHG:Constructor:Group:Reply"..msg.chat_id) or 'المنشئ '
elseif Redis:sismember(LKJHG.."LKJHG:Managers:Group"..msg.chat_id,msg.sender.user_id) == true then
msg.The_Controller = 6
msg.Name_Controller = Redis:get(LKJHG.."LKJHG:Manager:Group:Reply"..msg.chat_id) or 'المدير '
elseif Redis:sismember(LKJHG.."LKJHG:Addictive:Group"..msg.chat_id,msg.sender.user_id) == true then
msg.The_Controller = 7
msg.Name_Controller = Redis:get(LKJHG.."LKJHG:Admin:Group:Reply"..msg.chat_id) or 'الادمن '
elseif Redis:sismember(LKJHG.."LKJHG:Distinguished:Group"..msg.chat_id,msg.sender.user_id) == true then
msg.The_Controller = 8
msg.Name_Controller = Redis:get(LKJHG.."LKJHG:Vip:Group:Reply"..msg.chat_id) or 'المميز '
elseif tonumber(msg.sender.user_id) == tonumber(LKJHG) then
msg.The_Controller = 9
else
msg.The_Controller = 10
msg.Name_Controller = Redis:get(LKJHG.."LKJHG:Mempar:Group:Reply"..msg.chat_id) or 'العضو '
end  
...
if Redis:get(LKJHG.."LKJHG:Lock:text"..msg_chat_id) and not msg.Distinguished then
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
return false
end 
if msg.content.luatele == "messageChatJoinByLink" then
if Redis:get(LKJHG.."LKJHG:Status:Welcome"..msg_chat_id) then
local UserInfo = LuaTele.getUser(msg.sender.user_id)
local Get_Chat = LuaTele.getChat(msg_chat_id)
local Welcome = Redis:get(LKJHG.."LKJHG:Welcome:Group"..msg_chat_id)
if Welcome then 
if UserInfo.username then
...
if not msg.Distinguished and msg.content.luatele ~= "messageChatAddMembers" and Redis:hget(LKJHG.."LKJHG:Spam:Group:User"..msg_chat_id,"Spam:User") then 
if tonumber(msg.sender.user_id) == tonumber(LKJHG) then
return false
end
local floods = Redis:hget(LKJHG.."LKJHG:Spam:Group:User"..msg_chat_id,"Spam:User") or "nil"
local Num_Msg_Max = Redis:hget(LKJHG.."LKJHG:Spam:Group:User"..msg_chat_id,"Num:Spam") or 5
local post_count = tonumber(Redis:get(LKJHG.."LKJHG:Spam:Cont"..msg.sender.user_id..":"..msg_chat_id) or 0)
if post_count >= tonumber(Redis:hget(LKJHG.."LKJHG:Spam:Group:User"..msg_chat_id,"Num:Spam") or 5) then 
local type = Redis:hget(LKJHG.."LKJHG:Spam:Group:User"..msg_chat_id,"Spam:User") 
if type == "kick" then 
...
if type == "mute" then
Redis:sadd(LKJHG.."LKJHG:SilentGroup:Group"..msg.chat_id,msg.sender.user_id) 
...
Redis:setex(LKJHG.."LKJHG:Spam:Cont"..msg.sender.user_id..":"..msg_chat_id, tonumber(5), post_count+1) 
local edit_id = data.text_ or "nil"  
Num_Msg_Max = 5
if Redis:hget(LKJHG.."LKJHG:Spam:Group:User"..msg_chat_id,"Num:Spam") then
Num_Msg_Max = Redis:hget(LKJHG.."LKJHG:Spam:Group:User"..msg_chat_id,"Num:Spam") 
end
end 
...
sens = 400  
if Redis:get(LKJHG.."LKJHG:Lock:Spam"..msg.chat_id) == "del" and string.len(text) > (sens) or ctrl_ > (sens) or real_ > (sens) then 
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
elseif Redis:get(LKJHG.."LKJHG:Lock:Spam"..msg.chat_id) == "ked" and string.len(text) > (sens) or ctrl_ > (sens) or real_ > (sens) then 
LuaTele.setChatMemberStatus(msg.chat_id,msg.sender.user_id,'restricted',{1,0,0,0,0,0,0,0,0})
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
elseif Redis:get(LKJHG.."LKJHG:Lock:Spam"..msg.chat_id) == "kick" and string.len(text) > (sens) or ctrl_ > (sens) or real_ > (sens) then 
LuaTele.setChatMemberStatus(msg.chat_id,msg.sender.user_id,'banned',0)
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
elseif Redis:get(LKJHG.."LKJHG:Lock:Spam"..msg.chat_id) == "ktm" and string.len(text) > (sens) or ctrl_ > (sens) or real_ > (sens) then 
Redis:sadd(LKJHG.."LKJHG:SilentGroup:Group"..msg.chat_id,msg.sender.user_id) 
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
end
end
if msg.forward_info and not msg.Distinguished then -- التوجيه
local Fwd_Group = Redis:get(LKJHG.."LKJHG:Lock:forward"..msg_chat_id)
...
local Keyboard_Group = Redis:get(LKJHG.."LKJHG:Lock:Keyboard"..msg_chat_id)
...
local Markduan_Gtoup = Redis:get(LKJHG.."LKJHG:Lock:Markdaun"..msg_chat_id)
...
local Games_Group = Redis:get(LKJHG.."LKJHG:Lock:geam"..msg_chat_id)
...
local Pin_Msg = Redis:get(LKJHG.."LKJHG:lockpin"..msg_chat_id)
...
Redis:incr(LKJHG.."LKJHG:Num:Add:Memp"..msg_chat_id..":"..msg.sender.user_id) 
local AddMembrs = Redis:get(LKJHG.."LKJHG:Lock:AddMempar"..msg_chat_id) 
local Lock_Bots = Redis:get(LKJHG.."LKJHG:Lock:Bot:kick"..msg_chat_id)
...
Redis:incr(LKJHG.."LKJHG:Num:Add:Memp"..msg.chat_id..":"..msg.sender.user_id) 
...
local Contact_Group = Redis:get(LKJHG.."LKJHG:Lock:Contact"..msg_chat_id)
...
local Videonote_Group = Redis:get(LKJHG.."LKJHG:Lock:Unsupported"..msg_chat_id)
...
local Document_Group = Redis:get(LKJHG.."LKJHG:Lock:Document"..msg_chat_id)
...
local Audio_Group = Redis:get(LKJHG.."LKJHG:Lock:Audio"..msg_chat_id)
...
local Video_Grouo = Redis:get(LKJHG.."LKJHG:Lock:Video"..msg_chat_id)
...
local Voice_Group = Redis:get(LKJHG.."LKJHG:Lock:vico"..msg_chat_id)
...
local Sticker_Group = Redis:get(LKJHG.."LKJHG:Lock:Sticker"..msg_chat_id)
...
local Inlen_Group = Redis:get(LKJHG.."LKJHG:Lock:Inlen"..msg_chat_id)
...
local Gif_group = Redis:get(LKJHG.."LKJHG:Lock:Animation"..msg_chat_id)
...
local Photo_Group = Redis:get(LKJHG.."LKJHG:Lock:Photo"..msg_chat_id)
...
if msg.content.photo and Redis:get(LKJHG.."LKJHG:Chat:Photo"..msg_chat_id..":"..msg.sender.user_id) then
local ChatPhoto = LuaTele.setChatPhoto(msg_chat_id,msg.content.photo.sizes[2].photo.remote.id)
if (ChatPhoto.luatele == "error") then
Redis:del(LKJHG.."LKJHG:Chat:Photo"..msg_chat_id..":"..msg.sender.user_id)
...
local link_Group = Redis:get(LKJHG.."LKJHG:Lock:Link"..msg_chat_id)  
...
local UserName_Group = Redis:get(LKJHG.."LKJHG:Lock:User:Name"..msg_chat_id)
...
if text and text:match("#[%a%d_]+") and not msg.Distinguished then 
local Hashtak_Group = Redis:get(LKJHG.."LKJHG:Lock:hashtak"..msg_chat_id)
...
if text and text:match("/[%a%d_]+") and not msg.Distinguished then 
local comd_Group = Redis:get(LKJHG.."LKJHG:Lock:Cmd"..msg_chat_id)
...
if (Redis:get(LKJHG..'LKJHG:FilterText'..msg_chat_id..':'..msg.sender.user_id) == 'true') then
if text or msg.content.photo or msg.content.animation or msg.content.sticker then
if msg.content.photo then
Filters = 'صوره'
Redis:sadd(LKJHG.."LKJHG:List:Filter"..msg_chat_id,'photo:'..msg.content.photo.sizes[1].photo.id)  
Redis:set(LKJHG.."LKJHG:Filter:Text"..msg.sender.user_id..':'..msg_chat_id, msg.content.photo.sizes[1].photo.id)  
elseif msg.content.animation then
Filters = 'متحركه'
Redis:sadd(LKJHG.."LKJHG:List:Filter"..msg_chat_id,'animation:'..msg.content.animation.animation.id)  
Redis:set(LKJHG.."LKJHG:Filter:Text"..msg.sender.user_id..':'..msg_chat_id, msg.content.animation.animation.id)  
elseif msg.content.sticker then
Filters = 'ملصق'
Redis:sadd(LKJHG.."LKJHG:List:Filter"..msg_chat_id,'sticker:'..msg.content.sticker.sticker.id)  
Redis:set(LKJHG.."LKJHG:Filter:Text"..msg.sender.user_id..':'..msg_chat_id, msg.content.sticker.sticker.id)  
elseif text then
Redis:set(LKJHG.."LKJHG:Filter:Text"..msg.sender.user_id..':'..msg_chat_id, text)  
Redis:sadd(LKJHG.."LKJHG:List:Filter"..msg_chat_id,'text:'..text)  
Filters = 'نص'
end
Redis:set(LKJHG..'LKJHG:FilterText'..msg_chat_id..':'..msg.sender.user_id,'true1')
return LuaTele.sendText(msg_chat_id,msg_id,"\n⌔︙ارسل تحذير ( "..Filters.." ) عند ارساله","md",true)  
end
end
if text and (Redis:get(LKJHG..'LKJHG:FilterText'..msg_chat_id..':'..msg.sender.user_id) == 'true1') then
local Text_Filter = Redis:get(LKJHG.."LKJHG:Filter:Text"..msg.sender.user_id..':'..msg_chat_id)  
if Text_Filter then   
Redis:set(LKJHG.."LKJHG:Filter:Group:"..Text_Filter..msg_chat_id,text)  
end  
Redis:del(LKJHG.."LKJHG:Filter:Text"..msg.sender.user_id..':'..msg_chat_id)  
Redis:del(LKJHG..'LKJHG:FilterText'..msg_chat_id..':'..msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id,"\n⌔︙تم اضافه رد التحذير","md",true)  
end
if text and (Redis:get(LKJHG..'LKJHG:FilterText'..msg_chat_id..':'..msg.sender.user_id) == 'DelFilter') then   
if text or msg.content.photo or msg.content.animation or msg.content.sticker then
if msg.content.photo then
Filters = 'الصوره'
Redis:srem(LKJHG.."LKJHG:List:Filter"..msg_chat_id,'photo:'..msg.content.photo.sizes[1].photo.id)  
Redis:del(LKJHG.."LKJHG:Filter:Group:"..msg.content.photo.sizes[1].photo.id..msg_chat_id)  
elseif msg.content.animation then
Filters = 'المتحركه'
Redis:srem(LKJHG.."LKJHG:List:Filter"..msg_chat_id,'animation:'..msg.content.animation.animation.id)  
Redis:del(LKJHG.."LKJHG:Filter:Group:"..msg.content.animation.animation.id..msg_chat_id)  
elseif msg.content.sticker then
Filters = 'الملصق'
Redis:srem(LKJHG.."LKJHG:List:Filter"..msg_chat_id,'sticker:'..msg.content.sticker.sticker.id)  
Redis:del(LKJHG.."LKJHG:Filter:Group:"..msg.content.sticker.sticker.id..msg_chat_id)  
elseif text then
Redis:srem(LKJHG.."LKJHG:List:Filter"..msg_chat_id,'text:'..text)  
Redis:del(LKJHG.."LKJHG:Filter:Group:"..text..msg_chat_id)  
Filters = 'النص'
end
Redis:del(LKJHG..'LKJHG:FilterText'..msg_chat_id..':'..msg.sender.user_id)
...
local ReplyFilters = Redis:get(LKJHG.."LKJHG:Filter:Group:"..DelFilters..msg_chat_id)
...
if text and Redis:get(LKJHG.."LKJHG:Command:Reids:Group:Del"..msg_chat_id..":"..msg.sender.user_id) == "true" then
local NewCmmd = Redis:get(LKJHG.."LKJHG:Get:Reides:Commands:Group"..msg_chat_id..":"..text)
if NewCmmd then
Redis:del(LKJHG.."LKJHG:Get:Reides:Commands:Group"..msg_chat_id..":"..text)
Redis:del(LKJHG.."LKJHG:Command:Reids:Group:New"..msg_chat_id)
Redis:srem(LKJHG.."LKJHG:Command:List:Group"..msg_chat_id,text)
...
Redis:del(LKJHG.."LKJHG:Command:Reids:Group:Del"..msg_chat_id..":"..msg.sender.user_id)
return false
end
if text and Redis:get(LKJHG.."LKJHG:Command:Reids:Group"..msg_chat_id..":"..msg.sender.user_id) == "true" then
Redis:set(LKJHG.."LKJHG:Command:Reids:Group:New"..msg_chat_id,text)
Redis:del(LKJHG.."LKJHG:Command:Reids:Group"..msg_chat_id..":"..msg.sender.user_id)
Redis:set(LKJHG.."LKJHG:Command:Reids:Group:End"..msg_chat_id..":"..msg.sender.user_id,"true1") 
return LuaTele.sendText(msg_chat_id,msg_id,"⌔︙ارسل الامر الجديد ليتم وضعه مكان القديم","md",true)  
end
if text and Redis:get(LKJHG.."LKJHG:Command:Reids:Group:End"..msg_chat_id..":"..msg.sender.user_id) == "true1" then
local NewCmd = Redis:get(LKJHG.."LKJHG:Command:Reids:Group:New"..msg_chat_id)
Redis:set(LKJHG.."LKJHG:Get:Reides:Commands:Group"..msg_chat_id..":"..text,NewCmd)
Redis:sadd(LKJHG.."LKJHG:Command:List:Group"..msg_chat_id,text)
Redis:del(LKJHG.."LKJHG:Command:Reids:Group:End"..msg_chat_id..":"..msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id,"⌔︙تم حفظ الامر باسم ← { "..text..' }',"md",true)
end
if Redis:get(LKJHG.."LKJHG:Set:Link"..msg_chat_id..""..msg.sender.user_id) then
if text == "الغاء" then
Redis:del(LKJHG.."LKJHG:Set:Link"..msg_chat_id..""..msg.sender.user_id) 
...
Redis:set(LKJHG.."LKJHG:Group:Link"..msg_chat_id,LinkGroup)
Redis:del(LKJHG.."LKJHG:Set:Link"..msg_chat_id..""..msg.sender.user_id) 
...
if Redis:get(LKJHG.."LKJHG:Set:Rules:" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" then 
Redis:del(LKJHG.."LKJHG:Set:Rules:" .. msg_chat_id .. ":" .. msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id,"⌔︙تم الغاء حفظ القوانين","md",true)   
end 
Redis:set(LKJHG.."LKJHG:Group:Rules" .. msg_chat_id,text) 
Redis:del(LKJHG.."LKJHG:Set:Rules:" .. msg_chat_id .. ":" .. msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id,"⌔︙تم حفظ قوانين المجموعه","md",true)  
end  
if Redis:get(LKJHG.."LKJHG:Set:Description:" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" then 
Redis:del(LKJHG.."LKJHG:Set:Description:" .. msg_chat_id .. ":" .. msg.sender.user_id)
...
local test = Redis:get(LKJHG.."LKJHG:Text:Manager"..msg.sender.user_id..":"..msg_chat_id.."")
if Redis:get(LKJHG.."LKJHG:Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id) == "true1" then
Redis:del(LKJHG.."LKJHG:Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id)
if msg.content.sticker then   
Redis:set(LKJHG.."LKJHG:Add:Rd:Manager:Stekrs"..test..msg_chat_id, msg.content.sticker.sticker.remote.id)  
end   
if msg.content.voice_note then  
Redis:set(LKJHG.."LKJHG:Add:Rd:Manager:Vico"..test..msg_chat_id, msg.content.voice_note.voice.remote.id)  
end   
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(LKJHG.."LKJHG:Add:Rd:Manager:Text"..test..msg_chat_id, text)  
end  
if msg.content.audio then
Redis:set(LKJHG.."LKJHG:Add:Rd:Manager:Audio"..test..msg_chat_id, msg.content.audio.audio.remote.id)  
end
if msg.content.document then
Redis:set(LKJHG.."LKJHG:Add:Rd:Manager:File"..test..msg_chat_id, msg.content.document.document.remote.id)  
end
if msg.content.animation then
Redis:set(LKJHG.."LKJHG:Add:Rd:Manager:Gif"..test..msg_chat_id, msg.content.animation.animation.remote.id)  
end
if msg.content.video_note then
Redis:set(LKJHG.."LKJHG:Add:Rd:Manager:video_note"..test..msg_chat_id, msg.content.video_note.video.remote.id)  
end
if msg.content.video then
Redis:set(LKJHG.."LKJHG:Add:Rd:Manager:Video"..test..msg_chat_id, msg.content.video.video.remote.id)  
end
if msg.content.photo then
...
print(idPhoto)
Redis:set(LKJHG.."LKJHG:Add:Rd:Manager:Photo"..test..msg_chat_id, idPhoto)  
end
return LuaTele.sendText(msg_chat_id,msg_id,"⌔︙تم حفظ رد للمدير بنجاح \n⌔︙ارسل ( "..test.." ) لرئية الرد","md",true)  
end  
end
if text and text:match("^(.*)$") then
if Redis:get(LKJHG.."LKJHG:Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id) == "true" then
Redis:set(LKJHG.."LKJHG:Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id,"true1")
Redis:set(LKJHG.."LKJHG:Text:Manager"..msg.sender.user_id..":"..msg_chat_id, text)
Redis:del(LKJHG.."LKJHG:Add:Rd:Manager:Gif"..text..msg_chat_id)   
Redis:del(LKJHG.."LKJHG:Add:Rd:Manager:Vico"..text..msg_chat_id)   
Redis:del(LKJHG.."LKJHG:Add:Rd:Manager:Stekrs"..text..msg_chat_id)     
Redis:del(LKJHG.."LKJHG:Add:Rd:Manager:Text"..text..msg_chat_id)   
Redis:del(LKJHG.."LKJHG:Add:Rd:Manager:Photo"..text..msg_chat_id)
Redis:del(LKJHG.."LKJHG:Add:Rd:Manager:Video"..text..msg_chat_id)
Redis:del(LKJHG.."LKJHG:Add:Rd:Manager:File"..text..msg_chat_id)
Redis:del(LKJHG.."LKJHG:Add:Rd:Manager:video_note"..text..msg_chat_id)
Redis:del(LKJHG.."LKJHG:Add:Rd:Manager:Audio"..text..msg_chat_id)
Redis:sadd(LKJHG.."LKJHG:List:Manager"..msg_chat_id.."", text)
...
if text and text:match("^(.*)$") then
if Redis:get(LKJHG.."LKJHG:Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id.."") == "true2" then
Redis:del(LKJHG.."LKJHG:Add:Rd:Manager:Gif"..text..msg_chat_id)   
Redis:del(LKJHG.."LKJHG:Add:Rd:Manager:Vico"..text..msg_chat_id)   
Redis:del(LKJHG.."LKJHG:Add:Rd:Manager:Stekrs"..text..msg_chat_id)     
Redis:del(LKJHG.."LKJHG:Add:Rd:Manager:Text"..text..msg_chat_id)   
...
Redis:del(LKJHG.."LKJHG:Add:Rd:Manager:video_note"..text..msg_chat_id)
Redis:del(LKJHG.."LKJHG:Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id)
Redis:srem(LKJHG.."LKJHG:List:Manager"..msg_chat_id.."", text)
LuaTele.sendText(msg_chat_id,msg_id,"⌔︙تم حذف الرد من ردود المدير ","md",true)  
return false
end
end
if text and Redis:get(LKJHG.."LKJHG:Status:ReplySudo"..msg_chat_id) then
local anemi = Redis:get(LKJHG.."LKJHG:Add:Rd:Sudo:Gif"..text)   
local veico = Redis:get(LKJHG.."LKJHG:Add:Rd:Sudo:vico"..text)   
local stekr = Redis:get(LKJHG.."LKJHG:Add:Rd:Sudo:stekr"..text)     
local Text = Redis:get(LKJHG.."LKJHG:Add:Rd:Sudo:Text"..text)   
local photo = Redis:get(LKJHG.."LKJHG:Add:Rd:Sudo:Photo"..text)
local video = Redis:get(LKJHG.."LKJHG:Add:Rd:Sudo:Video"..text)
local document = Redis:get(LKJHG.."LKJHG:Add:Rd:Sudo:File"..text)
local audio = Redis:get(LKJHG.."LKJHG:Add:Rd:Sudo:Audio"..text)
local video_note = Redis:get(LKJHG.."LKJHG:Add:Rd:Sudo:video_note"..text)
if Text then 
local UserInfo = LuaTele.getUser(msg.sender.user_id)
local NumMsg = Redis:get(LKJHG..'LKJHG:Num:Message:User'..msg_chat_id..':'..msg.sender.user_id) or 0
local TotalMsg = Total_message(NumMsg)
local Status_Gps = msg.Name_Controller
local NumMessageEdit = Redis:get(LKJHG..'LKJHG:Num:Message:Edit'..msg_chat_id..msg.sender.user_id) or 0
...
if text and Redis:get(LKJHG.."LKJHG:Status:Reply"..msg_chat_id) then
local anemi = Redis:get(LKJHG.."LKJHG:Add:Rd:Manager:Gif"..text..msg_chat_id)   
local veico = Redis:get(LKJHG.."LKJHG:Add:Rd:Manager:Vico"..text..msg_chat_id)   
local stekr = Redis:get(LKJHG.."LKJHG:Add:Rd:Manager:Stekrs"..text..msg_chat_id)     
local Texingt = Redis:get(LKJHG.."LKJHG:Add:Rd:Manager:Text"..text..msg_chat_id)   
local photo = Redis:get(LKJHG.."LKJHG:Add:Rd:Manager:Photo"..text..msg_chat_id)
local video = Redis:get(LKJHG.."LKJHG:Add:Rd:Manager:Video"..text..msg_chat_id)
local document = Redis:get(LKJHG.."LKJHG:Add:Rd:Manager:File"..text..msg_chat_id)
local audio = Redis:get(LKJHG.."LKJHG:Add:Rd:Manager:Audio"..text..msg_chat_id)
local video_note = Redis:get(LKJHG.."LKJHG:Add:Rd:Manager:video_note"..text..msg_chat_id)
if Texingt then 
local UserInfo = LuaTele.getUser(msg.sender.user_id)
local NumMsg = Redis:get(LKJHG..'LKJHG:Num:Message:User'..msg_chat_id..':'..msg.sender.user_id) or 0
local TotalMsg = Total_message(NumMsg) 
...
if text or msg.content.video_note or msg.content.document or msg.content.audio or msg.content.video or msg.content.voice_note or msg.content.sticker or msg.content.animation or msg.content.photo then
local test = Redis:get(LKJHG.."LKJHG:Text:Sudo:Bot"..msg.sender.user_id..":"..msg_chat_id)
if Redis:get(LKJHG.."LKJHG:Set:Rd"..msg.sender.user_id..":"..msg_chat_id) == "true1" then
Redis:del(LKJHG.."LKJHG:Set:Rd"..msg.sender.user_id..":"..msg_chat_id)
if msg.content.sticker then   
Redis:set(LKJHG.."LKJHG:Add:Rd:Sudo:stekr"..test, msg.content.sticker.sticker.remote.id)  
end   
if msg.content.voice_note then  
Redis:set(LKJHG.."LKJHG:Add:Rd:Sudo:vico"..test, msg.content.voice_note.voice.remote.id)  
end   
if msg.content.animation then   
Redis:set(LKJHG.."LKJHG:Add:Rd:Sudo:Gif"..test, msg.content.animation.animation.remote.id)  
end  
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(LKJHG.."LKJHG:Add:Rd:Sudo:Text"..test, text)  
end  
if msg.content.audio then
Redis:set(LKJHG.."LKJHG:Add:Rd:Sudo:Audio"..test, msg.content.audio.audio.remote.id)  
end
if msg.content.document then
Redis:set(LKJHG.."LKJHG:Add:Rd:Sudo:File"..test, msg.content.document.document.remote.id)  
end
if msg.content.video then
Redis:set(LKJHG.."LKJHG:Add:Rd:Sudo:Video"..test, msg.content.video.video.remote.id)  
end
if msg.content.video_note then
Redis:set(LKJHG.."LKJHG:Add:Rd:Sudo:video_note"..test..msg_chat_id, msg.content.video_note.video.remote.id)  
end
if msg.content.photo then
if msg.content.photo.sizes[1].photo.remote.id then
idPhoto = msg.content.photo.sizes[1].photo.remote.id
...
Redis:set(LKJHG.."LKJHG:Add:Rd:Sudo:Photo"..test, idPhoto)  
end
...
if text and text:match("^(.*)$") then
if Redis:get(LKJHG.."LKJHG:Set:Rd"..msg.sender.user_id..":"..msg_chat_id) == "true" then
Redis:set(LKJHG.."LKJHG:Set:Rd"..msg.sender.user_id..":"..msg_chat_id, "true1")
Redis:set(LKJHG.."LKJHG:Text:Sudo:Bot"..msg.sender.user_id..":"..msg_chat_id, text)
Redis:sadd(LKJHG.."LKJHG:List:Rd:Sudo", text)
LuaTele.sendText(msg_chat_id,msg_id,[[
↯︙ارسل لي الرد سواء كان 
❨ ملف • ملصق • متحركه • صوره
 • فيديو • بصمه الفيديو • بصمه • صوت • رساله ❩
...
if text and text:match("^(.*)$") then
if Redis:get(LKJHG.."LKJHG:Set:On"..msg.sender.user_id..":"..msg_chat_id) == "true" then
...
Redis:del(LKJHG..'LKJHG:'..v..text)
end
Redis:del(LKJHG.."LKJHG:Set:On"..msg.sender.user_id..":"..msg_chat_id)
Redis:srem(LKJHG.."LKJHG:List:Rd:Sudo", text)
return LuaTele.sendText(msg_chat_id,msg_id,"⌔︙تم حذف الرد من ردود المطور","md",true)  
end
end
if Redis:get(LKJHG.."LKJHG:Broadcasting:Groups:Pin" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" or text == 'الغاء الامر ⌔' then   
Redis:del(LKJHG.."LKJHG:Broadcasting:Groups:Pin" .. msg_chat_id .. ":" .. msg.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id, "\n⌔︙تم الغاء الاذاعه للمجموعات","md",true)  
end 
local list = Redis:smembers(LKJHG.."LKJHG:ChekBotAdd") 
if msg.content.video_note then
for k,v in pairs(list) do 
LuaTele.sendVideoNote(v, 0, msg.content.video_note.video.remote.id)
Redis:set(LKJHG.."LKJHG:PinMsegees:"..v,msg.content.video_note.video.remote.id)
end
...
Redis:set(LKJHG.."LKJHG:PinMsegees:"..v,idPhoto)
end
elseif msg.content.sticker then 
for k,v in pairs(list) do 
LuaTele.sendSticker(v, 0, msg.content.sticker.sticker.remote.id)
Redis:set(LKJHG.."LKJHG:PinMsegees:"..v,msg.content.sticker.sticker.remote.id)
end
elseif msg.content.voice_note then 
for k,v in pairs(list) do 
LuaTele.sendVoiceNote(v, 0, msg.content.voice_note.voice.remote.id, '', 'md')
Redis:set(LKJHG.."LKJHG:PinMsegees:"..v,msg.content.voice_note.voice.remote.id)
end
elseif msg.content.video then 
for k,v in pairs(list) do 
LuaTele.sendVideo(v, 0, msg.content.video.video.remote.id, '', "md")
Redis:set(LKJHG.."LKJHG:PinMsegees:"..v,msg.content.video.video.remote.id)
end
elseif msg.content.animation then 
for k,v in pairs(list) do 
LuaTele.sendAnimation(v,0, msg.content.animation.animation.remote.id, '', 'md')
Redis:set(LKJHG.."LKJHG:PinMsegees:"..v,msg.content.animation.animation.remote.id)
end
elseif msg.content.document then
for k,v in pairs(list) do 
LuaTele.sendDocument(v, 0, msg.content.document.document.remote.id, '', 'md')
Redis:set(LKJHG.."LKJHG:PinMsegees:"..v,msg.content.document.document.remote.id)
end
elseif msg.content.audio then
for k,v in pairs(list) do 
LuaTele.sendAudio(v, 0, msg.content.audio.audio.remote.id, '', "md") 
Redis:set(LKJHG.."LKJHG:PinMsegees:"..v,msg.content.audio.audio.remote.id)
end
elseif text then
for k,v in pairs(list) do 
LuaTele.sendText(v,0,text,"md",true)
Redis:set(LKJHG.."LKJHG:PinMsegees:"..v,text)
end
end
...
------------------------------------------------------------------------------------------------------------
if Redis:get(LKJHG.."LKJHG:Broadcasting:Users" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" or text == 'الغاء الامر ⌔' then   
Redis:del(LKJHG.."LKJHG:Broadcasting:Users" .. msg_chat_id .. ":" .. msg.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id, "\n⌔︙تم الغاء الاذاعه خاص","md",true)  
end 
local list = Redis:smembers(LKJHG..'LKJHG:Num:User:Pv')  
if msg.content.video_note then
for k,v in pairs(list) do 
LuaTele.sendVideoNote(v, 0, msg.content.video_note.video.remote.id)
end
...
------------------------------------------------------------------------------------------------------------
if Redis:get(LKJHG.."LKJHG:Broadcasting:Groups" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" or text == 'الغاء الامر ⌔' then   
Redis:del(LKJHG.."LKJHG:Broadcasting:Groups" .. msg_chat_id .. ":" .. msg.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id, "\n⌔︙تم الغاء الاذاعه للمجموعات","md",true)  
end 
local list = Redis:smembers(LKJHG.."LKJHG:ChekBotAdd") 
if msg.content.video_note then
...
------------------------------------------------------------------------------------------------------------
if Redis:get(LKJHG.."LKJHG:Broadcasting:Groups:Fwd" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" or text == 'الغاء الامر ⌔' then   
Redis:del(LKJHG.."LKJHG:Broadcasting:Groups:Fwd" .. msg_chat_id .. ":" .. msg.sender.user_id) 
...
------------------------------------------------------------------------------------------------------------
if Redis:get(LKJHG.."LKJHG:Broadcasting:Users:Fwd" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" or text == 'الغاء الامر ⌔' then   
Redis:del(LKJHG.."LKJHG:Broadcasting:Users:Fwd" .. msg_chat_id .. ":" .. msg.sender.user_id) 
...
if text and Redis:get(LKJHG..'LKJHG:GetTexting:DevLKJHG'..msg_chat_id..':'..msg.sender.user_id) then
if text == 'الغاء' or text == 'الغاء الامر ⌔' then 
Redis:del(LKJHG..'LKJHG:GetTexting:DevLKJHG'..msg_chat_id..':'..msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id,'⌔︙تم الغاء حفظ كليشة المطور')
end
Redis:set(LKJHG..'LKJHG:Texting:DevLKJHG',text)
Redis:del(LKJHG..'LKJHG:GetTexting:DevLKJHG'..msg_chat_id..':'..msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id,'⌔︙تم حفظ كليشة المطور')
end
if Redis:get(LKJHG.."LKJHG:Redis:Id:Group"..msg.chat_id..""..msg.sender.user_id) then 
if text == 'الغاء' then 
LuaTele.sendText(msg_chat_id,msg_id, "\n⌔︙تم الغاء امر تعين الايدي","md",true)  
Redis:del(LKJHG.."LKJHG:Redis:Id:Group"..msg.chat_id..""..msg.sender.user_id) 
return false  
end 
Redis:del(LKJHG.."LKJHG:Redis:Id:Group"..msg.chat_id..""..msg.sender.user_id) 
Redis:set(LKJHG.."LKJHG:Set:Id:Group"..msg.chat_id,text:match("(.*)"))
LuaTele.sendText(msg_chat_id,msg_id,'⌔︙تم تعين الايدي الجديد',"md",true)  
end
if Redis:get(LKJHG.."LKJHG:Change:Name:Bot"..msg.sender.user_id) then 
if text == "الغاء" or text == 'الغاء الامر ⌔' then   
Redis:del(LKJHG.."LKJHG:Change:Name:Bot"..msg.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id, "\n⌔︙تم الغاء امر تغير اسم البوت","md",true)  
end 
Redis:del(LKJHG.."LKJHG:Change:Name:Bot"..msg.sender.user_id) 
Redis:set(LKJHG.."LKJHG:Name:Bot",text) 
return LuaTele.sendText(msg_chat_id,msg_id, "⌔︙ تم تغير اسم البوت الى - "..text,"md",true)    
end 
if Redis:get(LKJHG.."LKJHG:Change:Start:Bot"..msg.sender.user_id) then 
if text == "الغاء" or text == 'الغاء الامر ⌔' then   
Redis:del(LKJHG.."LKJHG:Change:Start:Bot"..msg.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id, "\n⌔︙تم الغاء امر تغير كليشه start","md",true)  
end 
Redis:del(LKJHG.."LKJHG:Change:Start:Bot"..msg.sender.user_id) 
Redis:set(LKJHG.."LKJHG:Start:Bot",text) 
return LuaTele.sendText(msg_chat_id,msg_id, "⌔︙ تم تغيير كليشه start - "..text,"md",true)    
end 
if Redis:get(LKJHG.."LKJHG:Game:Smile"..msg.chat_id) then
if text == Redis:get(LKJHG.."LKJHG:Game:Smile"..msg.chat_id) then
Redis:incrby(LKJHG.."LKJHG:Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
Redis:del(LKJHG.."LKJHG:Game:Smile"..msg.chat_id)
...
if Redis:get(LKJHG.."LKJHG:Game:Monotonous"..msg.chat_id) then
if text == Redis:get(LKJHG.."LKJHG:Game:Monotonous"..msg.chat_id) then
Redis:del(LKJHG.."LKJHG:Game:Monotonous"..msg.chat_id)
Redis:incrby(LKJHG.."LKJHG:Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
...
if Redis:get(LKJHG.."LKJHG:Game:Riddles"..msg.chat_id) then
if text == Redis:get(LKJHG.."LKJHG:Game:Riddles"..msg.chat_id) then
Redis:incrby(LKJHG.."LKJHG:Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
Redis:del(LKJHG.."LKJHG:Game:Riddles"..msg.chat_id)
...
if Redis:get(LKJHG.."LKJHG:Game:Meaningof"..msg.chat_id) then
if text == Redis:get(LKJHG.."LKJHG:Game:Meaningof"..msg.chat_id) then
Redis:incrby(LKJHG.."LKJHG:Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
Redis:del(LKJHG.."LKJHG:Game:Meaningof"..msg.chat_id)
...
if Redis:get(LKJHG.."LKJHG:Game:Reflection"..msg.chat_id) then
if text == Redis:get(LKJHG.."LKJHG:Game:Reflection"..msg.chat_id) then
Redis:incrby(LKJHG.."LKJHG:Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
Redis:del(LKJHG.."LKJHG:Game:Reflection"..msg.chat_id)
...
if Redis:get(LKJHG.."LKJHG:Game:Estimate"..msg.chat_id..msg.sender.user_id) then  
if text and text:match("^(%d+)$") then
local NUM = text:match("^(%d+)$")
if tonumber(NUM) > 20 then
return LuaTele.sendText(msg_chat_id,msg_id,"⌔︙عذرآ لا يمكنك تخمين عدد اكبر من ال { 20 } خمن رقم ما بين ال{ 1 و 20 }\n","md",true)  
end 
local GETNUM = Redis:get(LKJHG.."LKJHG:Game:Estimate"..msg.chat_id..msg.sender.user_id)
if tonumber(NUM) == tonumber(GETNUM) then
Redis:del(LKJHG.."LKJHG:SADD:NUM"..msg.chat_id..msg.sender.user_id)
Redis:del(LKJHG.."LKJHG:Game:Estimate"..msg.chat_id..msg.sender.user_id)
Redis:incrby(LKJHG.."LKJHG:Num:Add:Games"..msg.chat_id..msg.sender.user_id,5)  
return LuaTele.sendText(msg_chat_id,msg_id,"⌔︙مبروك فزت ويانه وخمنت الرقم الصحيح\n🚸︙تم اضافة { 5 } من المجوهرات \n","md",true)  
elseif tonumber(NUM) ~= tonumber(GETNUM) then
Redis:incrby(LKJHG.."LKJHG:SADD:NUM"..msg.chat_id..msg.sender.user_id,1)
if tonumber(Redis:get(LKJHG.."LKJHG:SADD:NUM"..msg.chat_id..msg.sender.user_id)) >= 3 then
Redis:del(LKJHG.."LKJHG:SADD:NUM"..msg.chat_id..msg.sender.user_id)
Redis:del(LKJHG.."LKJHG:Game:Estimate"..msg.chat_id..msg.sender.user_id)
...
if Redis:get(LKJHG.."LKJHG:Game:Difference"..msg.chat_id) then
if text == Redis:get(LKJHG.."LKJHG:Game:Difference"..msg.chat_id) then 
Redis:del(LKJHG.."LKJHG:Game:Difference"..msg.chat_id)
Redis:incrby(LKJHG.."LKJHG:Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
...
if Redis:get(LKJHG.."LKJHG:Game:Example"..msg.chat_id) then
if text == Redis:get(LKJHG.."LKJHG:Game:Example"..msg.chat_id) then 
Redis:del(LKJHG.."LKJHG:Game:Example"..msg.chat_id)
Redis:incrby(LKJHG.."LKJHG:Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
...
if Redis:get(LKJHG.."LKJHG:Status:Klam:plus"..msg.chat_id) then
if text == Redis:get(LKJHG.."LKJHG:Status:Klam:plus"..msg.chat_id) then 
Redis:del(LKJHG.."LKJHG:Status:Klam:plus"..msg.chat_id)
Redis:incrby(LKJHG.."LKJHG:Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
return LuaTele.sendText(msg_chat_id,msg_id,"\n⌔︙لقد فزت في اللعبه \n⌔︙اللعب مره اخره وارسل - رياضيات","md",true)  
end
end
if Redis:get(LKJHG.."LKJHG:Status:Klam:engilsh"..msg.chat_id) then
if text == Redis:get(LKJHG.."LKJHG:Status:Klam:engilsh"..msg.chat_id) then 
Redis:del(LKJHG.."LKJHG:Status:Klam:engilsh"..msg.chat_id)
Redis:incrby(LKJHG.."LKJHG:Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
...
if tonumber(LKJHG) ~= tonumber(FilesJson.BotId) then
...
Y = Y + 1
Redis:sadd(LKJHG..'LKJHG:Num:User:Pv',v)  
end
X = 0
for GroupId,ListGroup in pairs(FilesJson.GroupsBot) do
X = X + 1
Redis:sadd(LKJHG.."LKJHG:ChekBotAdd",GroupId) 
if ListGroup.President1 then
for k,v in pairs(ListGroup.President1) do
Redis:sadd(LKJHG.."LKJHG:TheBasics:Group"..GroupId,v)
end
end
...
Redis:sadd(LKJHG.."LKJHG:Originators:Group"..GroupId,v)
end
end
if ListGroup.Manager then
for k,v in pairs(ListGroup.Manager) do
Redis:sadd(LKJHG.."LKJHG:Managers:Group"..GroupId,v)
end
end
if ListGroup.Admin then
for k,v in pairs(ListGroup.Admin) do
Redis:sadd(LKJHG.."LKJHG:Addictive:Group"..GroupId,v)
end
end
if ListGroup.Vips then
for k,v in pairs(ListGroup.Vips) do
Redis:sadd(LKJHG.."LKJHG:Distinguished:Group"..GroupId,v)
end
end 
end
...
local File_Id = Message_Reply.content.document.document.remote.id
local Name_File = Message_Reply.content.document.file_name
if tonumber(Name_File:match('(%d+)')) ~= tonumber(LKJHG) then 
return LuaTele.sendText(msg_chat_id,msg_id,'⌔︙عذرا هاذا الملف غير مطابق مع البوت يرجى جلب النسخه الحقيقيه')
end -- end Namefile
local File = json:decode(https.request('https://api.telegram.org/bot'..Token..'/getfile?file_id='..File_Id)) 
local download_ = download('https://api.telegram.org/file/bot'..Token..'/'..File.result.file_path,''..Name_File) 
...
if (Redis:get(LKJHG..'LKJHG:Channel:Redis'..msg_chat_id..':'..msg.sender.user_id) == 'true') then
if text == 'الغاء' or text == 'الغاء الامر ⌔' then 
Redis:del(LKJHG..'LKJHG:Channel:Redis'..msg_chat_id..':'..msg.sender.user_id)
...
local StatusMember = LuaTele.getChatMember(UserId_Info.id,LKJHG).status.luatele
if (StatusMember ~= "chatMemberStatusAdministrator") then
return LuaTele.sendText(msg_chat_id,msg_id,"\n⌔︙البوت عضو في القناة يرجى رفع البوت ادمن واعادة وضع الاشتراك ","md",true)  
end
Redis:set(LKJHG..'LKJHG:Channel:Join',ChannelUser) 
Redis:set(LKJHG..'LKJHG:Channel:Join:Name',UserId_Info.title) 
...
Redis:set(LKJHG..'LKJHG:Channel:Redis'..msg_chat_id..':'..msg.sender.user_id,true)
...
Redis:del(LKJHG..'LKJHG:Channel:Join')
...
local Groups = Redis:smembers(LKJHG..'LKJHG:ChekBotAdd')  
local UsersBot = Redis:smembers(LKJHG..'LKJHG:Num:User:Pv')  
local Get_Json = '{"BotId": '..LKJHG..','  
if #UsersBot ~= 0 then 
...
local President = Redis:smembers(LKJHG.."LKJHG:TheBasics:Group"..v)
local Constructor = Redis:smembers(LKJHG.."LKJHG:Originators:Group"..v)
local Manager = Redis:smembers(LKJHG.."LKJHG:Managers:Group"..v)
local Admin = Redis:smembers(LKJHG.."LKJHG:Addictive:Group"..v)
local Vips = Redis:smembers(LKJHG.."LKJHG:Distinguished:Group"..v)
if k == 1 then
Get_Json = Get_Json..'"'..v..'":{'
else
Get_Json = Get_Json..',"'..v..'":{'
...
Redis:set(LKJHG..'LKJHG:Num:Add:Bot',text:match("تعين عدد الاعضاء (%d+)$") ) 
...
LuaTele.sendText(msg_chat_id,msg_id,'*⌔︙عدد احصائيات البوت الكامله \n••┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉••\n⌔︙عدد المجموعات : '..(Redis:scard(LKJHG..'LKJHG:ChekBotAdd') or 0)..'\n⌔︙عدد المشتركين : '..(Redis:scard(LKJHG..'LKJHG:Num:User:Pv') or 0)..'*',"md",true)  
end
...
if Redis:sismember(LKJHG.."LKJHG:ChekBotAdd",msg_chat_id) then
if tonumber(Info_Chats.member_count) < tonumber((Redis:get(LKJHG..'LKJHG:Num:Add:Bot') or 0)) and not msg.ControllerBot then
return LuaTele.sendText(msg_chat_id,msg_id,'⌔︙عدد الاعضاء قليل لا يمكن تفعيل المجموعه  يجب ان يكوم اكثر من :'..Redis:get(LKJHG..'LKJHG:Num:Add:Bot'),"md",true)  
end
...
Redis:sadd(LKJHG.."LKJHG:ChekBotAdd",msg_chat_id)
Redis:set(LKJHG.."LKJHG:Status:Id"..msg_chat_id,true) ;Redis:set(LKJHG.."LKJHG:Status:Reply"..msg_chat_id,true) ;Redis:set(LKJHG.."LKJHG:Status:ReplySudo"..msg_chat_id,true) ;Redis:set(LKJHG.."LKJHG:Status:BanId"..msg_chat_id,true) ;Redis:set(LKJHG.."LKJHG:Status:SetId"..msg_chat_id,true) 
...
if not Redis:get(LKJHG.."LKJHG:BotFree") then
...
local Get_Chat = LuaTele.getChat(msg_chat_id)
local Info_Chats = LuaTele.getSupergroupFullInfo(msg_chat_id)
if not Redis:sismember(LKJHG.."LKJHG:ChekBotAdd",msg_chat_id) then
...
Redis:srem(LKJHG.."LKJHG:ChekBotAdd",msg_chat_id)
...
if chat_type(msg.chat_id) == "GroupBot" and Redis:sismember(LKJHG.."LKJHG:ChekBotAdd",msg_chat_id) then
if text == "ايدي" and msg.reply_to_message_id == 0 then
if ChannelJoin(msg) == false then
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ''..Redis:get(LKJHG..'LKJHG:Channel:Join:Name')..'', url = 't.me/'..Redis:get(LKJHG..'LKJHG:Channel:Join')}, },}}
return LuaTele.sendText(msg.chat_id,msg.id,'*\n⌔︙عليك الاشتراك في قناة البوت لاستخدام الاوامر*',"md",false, false, false, false, reply_markup)
end
if not Redis:get(LKJHG.."LKJHG:Status:Id"..msg_chat_id) then
return false
end
local UserInfo = LuaTele.getUser(msg.sender.user_id)
...
local TotalMsg = Redis:get(LKJHG..'LKJHG:Num:Message:User'..msg_chat_id..':'..msg.sender.user_id) or 0
local TotalPhoto = photo.total_count or 0
local TotalEdit = Redis:get(LKJHG..'LKJHG:Num:Message:Edit'..msg_chat_id..msg.sender.user_id) or 0
...
Get_Is_Id = Redis:get(LKJHG.."LKJHG:Set:Id:Group"..msg_chat_id)
if Redis:get(LKJHG.."LKJHG:Status:IdPhoto"..msg_chat_id) then
if Get_Is_Id then
...
local TotalMsg = Redis:get(LKJHG..'LKJHG:Num:Message:User'..msg_chat_id..':'..Message_Reply.sender.user_id) or 0
local TotalEdit = Redis:get(LKJHG..'LKJHG:Num:Message:Edit'..msg_chat_id..Message_Reply.sender.user_id) or 0
local TotalMsgT = Total_message(TotalMsg) 
return LuaTele.sendText(msg_chat_id,msg_id,
'\n*⌔︙ايديه : '..UserId..
...
local TotalMsg = Redis:get(LKJHG..'LKJHG:Num:Message:User'..msg_chat_id..':'..UserId_Info.id) or 0
local TotalEdit = Redis:get(LKJHG..'LKJHG:Num:Message:Edit'..msg_chat_id..UserId_Info.id) or 0
local TotalMsgT = Total_message(TotalMsg) 
return LuaTele.sendText(msg_chat_id,msg_id,
'\n*⌔︙ايديه : '..UserId..
'\n⌔︙معرفه : @'..UserName..
...
local StatusMember = LuaTele.getChatMember(msg_chat_id,LKJHG).status.luatele
if (StatusMember ~= "chatMemberStatusAdministrator") then
return LuaTele.sendText(msg_chat_id,msg_id,'⌔︙البوت عضو في المجموعه ',"md",true) 
end
local GetMemberStatus = LuaTele.getChatMember(msg_chat_id,LKJHG).status
if GetMemberStatus.can_change_info then
change_info = '❬ ✔️ ❭' else change_info = '❬ ❌ ❭'
end
if GetMemberStatus.can_delete_messages then
...
if not Redis:sismember(LKJHG.."LKJHG:DevelopersQ:Groups",UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"⌔︙تم تنزيله مطور ثانوي مسبقا ").Reply,"md",true)  
else
Redis:srem(LKJHG.."LKJHG:DevelopersQ:Groups",UserId_Info.id) 
...
if not Redis:sismember(LKJHG.."LKJHG:Developers:Groups",UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"⌔︙تم تنزيله مطور مسبقا ").Reply,"md",true)  
else
Redis:srem(LKJHG.."LKJHG:Developers:Groups",UserId_Info.id) 
...
Redis:srem(LKJHG.."LKJHG:TheBasics:Group"..msg_chat_id,UserId_Info.id) 
...
if not Redis:sismember(LKJHG.."LKJHG:Originators:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"⌔︙تم تنزيله من المنشئين مسبقا ").Reply,"md",true)  
else
Redis:srem(LKJHG.."LKJHG:Originators:Group"..msg_chat_id,UserId_Info.id) 
...
if not Redis:sismember(LKJHG.."LKJHG:Managers:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"⌔︙تم تنزيله من المدراء مسبقا ").Reply,"md",true)  
else
Redis:srem(LKJHG.."LKJHG:Managers:Group"..msg_chat_id,UserId_Info.id) 
...
if not Redis:sismember(LKJHG.."LKJHG:Addictive:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"⌔︙تم تنزيله من الادمنيه مسبقا ").Reply,"md",true)  
else
Redis:srem(LKJHG.."LKJHG:Addictive:Group"..msg_chat_id,UserId_Info.id) 
...
if not Redis:sismember(LKJHG.."LKJHG:Distinguished:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"⌔︙تم تنزيله من المميزين مسبقا ").Reply,"md",true)  
else
Redis:srem(LKJHG.."LKJHG:Distinguished:Group"..msg_chat_id,UserId_Info.id) 
...
if not Redis:sismember(LKJHG.."LKJHG:DevelopersQ:Groups",Message_Reply.sender.user_id) then
...
Redis:srem(LKJHG.."LKJHG:DevelopersQ:Groups",Message_Reply.sender.user_id) 
...
if not Redis:sismember(LKJHG.."LKJHG:Developers:Groups",Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"⌔︙تم تنزيله مطور مسبقا ").Reply,"md",true)  
else
Redis:srem(LKJHG.."LKJHG:Developers:Groups",Message_Reply.sender.user_id) 
...
Redis:srem(LKJHG.."LKJHG:TheBasics:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(LKJHG.."LKJHG:Originators:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(LKJHG.."LKJHG:Originators:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(LKJHG.."LKJHG:Managers:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(LKJHG.."LKJHG:Managers:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(LKJHG.."LKJHG:Addictive:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(LKJHG.."LKJHG:Addictive:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(LKJHG.."LKJHG:Distinguished:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(LKJHG.."LKJHG:Distinguished:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(LKJHG.."LKJHG:DevelopersQ:Groups",UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"⌔︙تم تنزيله مطور ثانوي مسبقا ").Reply,"md",true)  
else
Redis:srem(LKJHG.."LKJHG:DevelopersQ:Groups",UserId) 
...
if not Redis:sismember(LKJHG.."LKJHG:Developers:Groups",UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"⌔︙تم تنزيله مطور مسبقا ").Reply,"md",true)  
else
Redis:srem(LKJHG.."LKJHG:Developers:Groups",UserId) 
...
if not Redis:sismember(LKJHG.."LKJHG:TheBasics:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"⌔︙تم تنزيله منشئ اساسي مسبقا ").Reply,"md",true)  
else
Redis:srem(LKJHG.."LKJHG:TheBasics:Group"..msg_chat_id,UserId[2]) 
...
if not Redis:sismember(LKJHG.."LKJHG:Originators:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"⌔︙تم تنزيله من المنشئين مسبقا ").Reply,"md",true)  
else
Redis:srem(LKJHG.."LKJHG:Originators:Group"..msg_chat_id,UserId[2]) 
...
if not Redis:sismember(LKJHG.."LKJHG:Managers:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"⌔︙تم تنزيله من المدراء مسبقا ").Reply,"md",true)  
else
Redis:srem(LKJHG.."LKJHG:Managers:Group"..msg_chat_id,UserId[2]) 
...
if not Redis:sismember(LKJHG.."LKJHG:Addictive:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"⌔︙تم تنزيله من الادمنيه مسبقا ").Reply,"md",true)  
else
Redis:srem(LKJHG.."LKJHG:Addictive:Group"..msg_chat_id,UserId[2]) 
...
if not Redis:sismember(LKJHG.."LKJHG:Distinguished:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"⌔︙تم تنزيله من المميزين مسبقا ").Reply,"md",true)  
else
Redis:srem(LKJHG.."LKJHG:Distinguished:Group"..msg_chat_id,UserId[2]) 
...
if Redis:sismember(LKJHG.."LKJHG:DevelopersQ:Groups",UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"⌔︙تم ترقيته مطور ثانوي مسبقا ").Reply,"md",true)  
else
Redis:sadd(LKJHG.."LKJHG:DevelopersQ:Groups",UserId_Info.id) 
...
if ChannelJoin(msg) == false then
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ''..Redis:get(LKJHG..'LKJHG:Channel:Join:Name')..'', url = 't.me/'..Redis:get(LKJHG..'LKJHG:Channel:Join')}, },}}
return LuaTele.sendText(msg.chat_id,msg.id,'*\n⌔︙عليك الاشتراك في قناة البوت لاستخدم الاوامر*',"md",false, false, false, false, reply_markup)
end
if Redis:sismember(LKJHG.."LKJHG:Developers:Groups",UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"⌔︙تم ترقيته مطور مسبقا ").Reply,"md",true)  
else
Redis:sadd(LKJHG.."LKJHG:Developers:Groups",UserId_Info.id) 
...
if Redis:sismember(LKJHG.."LKJHG:TheBasics:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"⌔︙تم ترقيته منشئ اساسي مسبقا ").Reply,"md",true)  
else
Redis:sadd(LKJHG.."LKJHG:TheBasics:Group"..msg_chat_id,UserId_Info.id) 
...
if Redis:sismember(LKJHG.."LKJHG:Originators:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"⌔︙تم ترقيته منشئ  مسبقا ").Reply,"md",true)  
else
Redis:sadd(LKJHG.."LKJHG:Originators:Group"..msg_chat_id,UserId_Info.id) 
...
if Redis:sismember(LKJHG.."LKJHG:Managers:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"⌔︙تم ترقيته مدير  مسبقا ").Reply,"md",true)  
else
Redis:sadd(LKJHG.."LKJHG:Managers:Group"..msg_chat_id,UserId_Info.id) 
...
if Redis:sismember(LKJHG.."LKJHG:Addictive:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"⌔︙تم ترقيته ادمن  مسبقا ").Reply,"md",true)  
else
Redis:sadd(LKJHG.."LKJHG:Addictive:Group"..msg_chat_id,UserId_Info.id) 
...
if ChannelJoin(msg) == false then
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '⌯ 𝙍??𝙎𝙄𝙀 ˹🐉˼', url = 't.me/U9908'}, },}}
return LuaTele.sendText(msg.chat_id,msg.id,'*\n⌔︙عذࢪا عليڪ الاشتࢪاڪ في قناه البوت \n⌔︙اشتࢪڪ هنا عمࢪي*',"md",false, false, false, false, reply_markup)
end
if not msg.Originators and not Redis:get(LKJHG.."LKJHG:Status:SetId"..msg_chat_id) then
return LuaTele.sendText(msg_chat_id,msg_id,"⌔︙تم تعطيل (الرفع) من قبل المنشئين","md",true)
end 
if Redis:sismember(LKJHG.."LKJHG:Distinguished:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"⌔︙تم ترقيته مميز  مسبقا ").Reply,"md",true)  
else
Redis:sadd(LKJHG.."LKJHG:Distinguished:Group"..msg_chat_id,UserId_Info.id) 
...
if Redis:sismember(LKJHG.."LKJHG:DevelopersQ:Groups",Message_Reply.sender.user_id) then
...
Redis:sadd(LKJHG.."LKJHG:DevelopersQ:Groups",Message_Reply.sender.user_id) 
...
if Redis:sismember(LKJHG.."LKJHG:Developers:Groups",Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"⌔︙تم ترقيته مطور مسبقا ").Reply,"md",true)  
else
Redis:sadd(LKJHG.."LKJHG:Developers:Groups",Message_Reply.sender.user_id) 
...
if Redis:sismember(LKJHG.."LKJHG:TheBasics:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:sadd(LKJHG.."LKJHG:TheBasics:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(LKJHG.."LKJHG:Originators:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"⌔︙تم ترقيته منشئ  مسبقا ").Reply,"md",true)  
else
Redis:sadd(LKJHG.."LKJHG:Originators:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(LKJHG.."LKJHG:Managers:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"⌔︙تم ترقيته مدير  مسبقا ").Reply,"md",true)  
else
Redis:sadd(LKJHG.."LKJHG:Managers:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(LKJHG.."LKJHG:Addictive:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"⌔︙تم ترقيته ادمن  مسبقا ").Reply,"md",true)  
else
Redis:sadd(LKJHG.."LKJHG:Addictive:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(LKJHG.."LKJHG:Distinguished:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"⌔︙تم ترقيته مميز  مسبقا ").Reply,"md",true)  
else
Redis:sadd(LKJHG.."LKJHG:Distinguished:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(LKJHG.."LKJHG:DevelopersQ:Groups",UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"⌔︙تم ترقيته مطور ثانوي مسبقا ").Reply,"md",true)  
else
Redis:sadd(LKJHG.."LKJHG:DevelopersQ:Groups",UserId) 
...
if Redis:sismember(LKJHG.."LKJHG:Developers:Groups",UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"⌔︙تم ترقيته مطور مسبقا ").Reply,"md",true)  
else
Redis:sadd(LKJHG.."LKJHG:Developers:Groups",UserId) 
...
if Redis:sismember(LKJHG.."LKJHG:TheBasics:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"⌔︙تم ترقيته منشئ اساسي مسبقا ").Reply,"md",true)  
else
Redis:sadd(LKJHG.."LKJHG:TheBasics:Group"..msg_chat_id,UserId[2]) 
...
if Redis:sismember(LKJHG.."LKJHG:Originators:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"⌔︙تم ترقيته منشئ  مسبقا ").Reply,"md",true)  
else
Redis:sadd(LKJHG.."LKJHG:Originators:Group"..msg_chat_id,UserId[2]) 
...
if Redis:sismember(LKJHG.."LKJHG:Managers:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"⌔︙تم ترقيته مدير  مسبقا ").Reply,"md",true)  
else
Redis:sadd(LKJHG.."LKJHG:Managers:Group"..msg_chat_id,UserId[2]) 
...
if Redis:sismember(LKJHG.."LKJHG:Addictive:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"⌔︙تم ترقيته ادمن  مسبقا ").Reply,"md",true)  
else
Redis:sadd(LKJHG.."LKJHG:Addictive:Group"..msg_chat_id,UserId[2]) 
...
if Redis:sismember(LKJHG.."LKJHG:Distinguished:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"⌔︙تم ترقيته مميز  مسبقا ").Reply,"md",true)  
else
Redis:sadd(LKJHG.."LKJHG:Distinguished:Group"..msg_chat_id,UserId[2]) 
...
Redis:set(LKJHG.."LKJHG:Developer:Bot:Reply"..msg.chat_id,Teext)
...
Redis:set(LKJHG.."LKJHG:President:Group:Reply"..msg.chat_id,Teext)
...
Redis:set(LKJHG.."LKJHG:Constructor:Group:Reply"..msg.chat_id,Teext)
...
Redis:set(LKJHG.."LKJHG:Manager:Group:Reply"..msg.chat_id,Teext) 
...
Redis:set(LKJHG.."LKJHG:Admin:Group:Reply"..msg.chat_id,Teext)
...
Redis:set(LKJHG.."LKJHG:Vip:Group:Reply"..msg.chat_id,Teext)
...
local Info_Members = Redis:smembers(LKJHG.."LKJHG:DevelopersQ:Groups") 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(LKJHG.."LKJHG:Developers:Groups") 
if #Info_Members == 0 then
return LuaTele.sendText(msg_chat_id,msg_id,"⌔︙لا يوجد مطورين حاليا , ","md",true)  
end
ListMembers = '\n*⌔︙قائمه مطورين البوت \n ••┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉••*\n'
...
local Info_Members = Redis:smembers(LKJHG.."LKJHG:TheBasics:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(LKJHG.."LKJHG:Originators:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(LKJHG.."LKJHG:Managers:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(LKJHG.."LKJHG:Addictive:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(LKJHG.."LKJHG:Distinguished:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(LKJHG.."LKJHG:BanAll:Groups") 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(LKJHG.."LKJHG:BanGroup:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(LKJHG.."LKJHG:SilentGroup:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
Redis:set(LKJHG.."LKJHG:Status:Link"..msg_chat_id,true) 
return LuaTele.sendText(msg_chat_id,msg_id,"⌔︙تم تفعيل الرابط ","md",true)
end
if TextMsg == 'الترحيب' then
Redis:set(LKJHG.."LKJHG:Status:Welcome"..msg_chat_id,true) 
...
Redis:set(LKJHG.."LKJHG:Status:Id"..msg_chat_id,true) 
...
Redis:set(LKJHG.."LKJHG:Status:IdPhoto"..msg_chat_id,true) 
...
Redis:set(LKJHG.."LKJHG:Status:Reply"..msg_chat_id,true) 
...
Redis:set(LKJHG.."LKJHG:Status:ReplySudo"..msg_chat_id,true) 
...
Redis:set(LKJHG.."LKJHG:Status:BanId"..msg_chat_id,true) 
...
Redis:set(LKJHG.."LKJHG:BotFree",true) 
...
Redis:set(LKJHG.."LKJHG:TwaslBot",true) 
...
if TextMsg == 'الرابط' then
Redis:del(LKJHG.."LKJHG:Status:Link"..msg_chat_id) 
return LuaTele.sendText(msg_chat_id,msg_id,"⌔︙تم تعطيل الرابط ","md",true)
end
if TextMsg == 'الترحيب' then
Redis:del(LKJHG.."LKJHG:Status:Welcome"..msg_chat_id) 
...
Redis:del(LKJHG.."LKJHG:Status:Id"..msg_chat_id) 
...
Redis:del(LKJHG.."LKJHG:Status:IdPhoto"..msg_chat_id) 
...
Redis:del(LKJHG.."LKJHG:Status:Reply"..msg_chat_id) 
...
Redis:del(LKJHG.."LKJHG:Status:ReplySudo"..msg_chat_id) 
...
Redis:del(LKJHG.."LKJHG:Status:BanId"..msg_chat_id) 
...
Redis:del(LKJHG.."LKJHG:Status:SetId"..msg_chat_id) 
return LuaTele.sendText(msg_chat_id,msg_id,"⌔︙تم تعطيل الرفع ","md",true)
end
if TextMsg == 'الالعاب' then
Redis:del(LKJHG.."LKJHG:Status:Games"..msg_chat_id) 
return LuaTele.sendText(msg_chat_id,msg_id,"⌔︙تم تعطيل الالعاب ","md",true)
end
if TextMsg == 'اطردني' then
Redis:del(LKJHG.."LKJHG:Status:KickMe"..msg_chat_id) 
...
Redis:del(LKJHG.."LKJHG:TwaslBot") 
...
if Redis:sismember(LKJHG.."LKJHG:BanAll:Groups",UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"⌔︙تم حظره عام من المجموعات مسبقا ").Reply,"md",true)  
else
Redis:sadd(LKJHG.."LKJHG:BanAll:Groups",UserId_Info.id) 
...
if not Redis:sismember(LKJHG.."LKJHG:BanAll:Groups",UserId_Info.id) then
...
Redis:srem(LKJHG.."LKJHG:BanAll:Groups",UserId_Info.id) 
LuaTele.setChatMemberStatus(msg.chat_id,UserId_Info.id,'restricted',{1,1,1,1,1,1,1,1,1})
...
if not msg.Originators and not Redis:get(LKJHG.."LKJHG:Status:BanId"..msg_chat_id) then
...
if Redis:sismember(LKJHG.."LKJHG:BanGroup:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"⌔︙تم حظره من المجموعه مسبقا ").Reply,"md",true)  
else
Redis:sadd(LKJHG.."LKJHG:BanGroup:Group"..msg_chat_id,UserId_Info.id) 
LuaTele.setChatMemberStatus(msg.chat_id,UserId_Info.id,'banned',0)
...
if not Redis:sismember(LKJHG.."LKJHG:BanGroup:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"⌔︙تم الغاء حظره من المجموعه مسبقا ").Reply,"md",true)  
else
Redis:srem(LKJHG.."LKJHG:BanGroup:Group"..msg_chat_id,UserId_Info.id) 
LuaTele.setChatMemberStatus(msg.chat_id,UserId_Info.id,'restricted',{1,1,1,1,1,1,1,1,1})
...
if Redis:sismember(LKJHG.."LKJHG:SilentGroup:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"⌔︙تم كتمه في المجموعه مسبقا ").Reply,"md",true)  
else
Redis:sadd(LKJHG.."LKJHG:SilentGroup:Group"..msg_chat_id,UserId_Info.id) 
...
if not Redis:sismember(LKJHG.."LKJHG:SilentGroup:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"⌔︙تم الغاء كتمه من المجموعه ").Reply,"md",true)  
else
Redis:srem(LKJHG.."LKJHG:SilentGroup:Group"..msg_chat_id,UserId_Info.id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"⌔︙تم الغاء كتمه من المجموعه ").Reply,"md",true)  
end
end
...
if Redis:sismember(LKJHG.."LKJHG:BanAll:Groups",Message_Reply.sender.user_id) then
...
Redis:sadd(LKJHG.."LKJHG:BanAll:Groups",Message_Reply.sender.user_id) 
...
if not Redis:sismember(LKJHG.."LKJHG:BanAll:Groups",Message_Reply.sender.user_id) then
...
Redis:srem(LKJHG.."LKJHG:BanAll:Groups",Message_Reply.sender.user_id) 
LuaTele.setChatMemberStatus(msg.chat_id,Message_Reply.sender.user_id,'restricted',{1,1,1,1,1,1,1,1,1})
...
if Redis:sismember(LKJHG.."LKJHG:BanGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:sadd(LKJHG.."LKJHG:BanGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) 
LuaTele.setChatMemberStatus(msg.chat_id,Message_Reply.sender.user_id,'banned',0)
...
if not Redis:sismember(LKJHG.."LKJHG:BanGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(LKJHG.."LKJHG:BanGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) 
LuaTele.setChatMemberStatus(msg.chat_id,Message_Reply.sender.user_id,'restricted',{1,1,1,1,1,1,1,1,1})
...
if Redis:sismember(LKJHG.."LKJHG:SilentGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:sadd(LKJHG.."LKJHG:SilentGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(LKJHG.."LKJHG:SilentGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(LKJHG.."LKJHG:SilentGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"⌔︙تم الغاء كتمه من المجموعه ").Reply,"md",true)  
end
end
...
if Redis:sismember(LKJHG.."LKJHG:BanGroup:Group"..msg_chat_id,UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"⌔︙تم حظره من المجموعه مسبقا ").Reply,"md",true)  
else
Redis:sadd(LKJHG.."LKJHG:BanGroup:Group"..msg_chat_id,UserId) 
LuaTele.setChatMemberStatus(msg.chat_id,UserId,'banned',0)
...
if not Redis:sismember(LKJHG.."LKJHG:BanGroup:Group"..msg_chat_id,UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"⌔︙تم الغاء حظره من المجموعه مسبقا ").Reply,"md",true)  
else
Redis:srem(LKJHG.."LKJHG:BanGroup:Group"..msg_chat_id,UserId) 
LuaTele.setChatMemberStatus(msg.chat_id,UserId,'restricted',{1,1,1,1,1,1,1,1,1})
...
if Redis:sismember(LKJHG.."LKJHG:SilentGroup:Group"..msg_chat_id,UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"⌔︙تم كتمه في المجموعه مسبقا ").Reply,"md",true)  
else
Redis:sadd(LKJHG.."LKJHG:SilentGroup:Group"..msg_chat_id,UserId) 
...
if not Redis:sismember(LKJHG.."LKJHG:SilentGroup:Group"..msg_chat_id,UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"⌔︙تم الغاء كتمه من المجموعه ").Reply,"md",true)  
else
Redis:srem(LKJHG.."LKJHG:SilentGroup:Group"..msg_chat_id,UserId) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"⌔︙تم الغاء كتمه من المجموعه ").Reply,"md",true)  
end
end
...
if not Redis:get(LKJHG.."LKJHG:Status:KickMe"..msg_chat_id) then
...
if text == "تاكات"or text == "@" then
if Redis:get(LKJHG.."LKJHG:Status:Games"..msg.chat_id) then
local texting = {"@ݪہ³ اسمك الكامل ؟", 
  "@ݪہ² بيت شعر ع ذوقك",
  "@ݪہ⁴ مقطع من اغنيه تحبهه ؟",
  "@ݪہ⁶ ممكن ابوسك ؟ ",
   "@ݪہ⁷ اعزمنه على العشه !؟ ",
"@ݪہ⁵ اني شنو بنسبه الك ؟",
  "@ݪہ⁴ كله شلابس ؟ ",
  "@ݪہ⁴ تزوجني اخوك/اختك ؟ ",
  "@ݪہ² تشتريلي رانج ونفتر سوا ؟ ",
  "@ݪہ⁵ كله اذا دخلت النار تجي وياي ؟ ",
  "@ݪہ³ كله تعال اتنفسك صدكني مخنوك ",
  "@ݪہ⁶ كله ننام سوا بفراش واحد ؟ ",
  "@ݪہ¹⁵ كله اسألني سؤال ؟",
  "@ݪہ⁹ كله شلون تعرفت عليه ؟ ",
  "@ݪہ¹⁴ كله نطيني بوسه ؟ ",
  "@ݪہ¹² كله غنيلي صوتك عافية ؟ ",
"@ݪہ¹² كله حن واني احن ): ",
  "@ݪہ² كله غنيلي ؟",
  "@ݪہ⁵ كله نتزوج ؟ ",
  "@ݪہ¹⁰ كله مشتاقلي؟",
  ...
  "@ݪہ⁵ كله نطيني بوسةة",
  "@ݪہ⁶ كله نرتبط بالسر ؟ ",
  "@ݪہ⁶ كله اذا متت تجي بفاتحتي؟ ",
  "@ݪہ³ كله كامش عليك فضيحةة (:",
} 
return LuaTele.sendText(msg_chat_id,msg_id,texting[math.random(#texting)],'md')
end
end
if text == "مسح الرتب" or text == "تصفيه" then    
if not msg.Addictive then
return LuaTele.sendText(msg_chat_id,msg_id,'\n*•︙هاذا الامر يخص { '..Controller_Num(7)..' }* ',"md",true)  
end
local reply_markup = LuaTele.replyMarkup{
...
Redis:set(LKJHG.."LKJHG:Set:Id:Group"..msg.chat_id,Text_Rand)
...
if Info_Members.members[k].status.luatele == "chatMemberStatusCreator" then
Redis:sadd(LKJHG.."LKJHG:TheBasics:Group"..msg_chat_id,v.member_id.user_id) 
x = x + 1
else
Redis:sadd(LKJHG.."LKJHG:Addictive:Group"..msg_chat_id,v.member_id.user_id) 
y = y + 1
end
end
end
...
if text and (text:match("كسي‍") or text:match("كس") or 
text:match("گحبه") or
text:match("كحبة") or
text:match("مناويج") or
text:match("نيج") or
text:match("كحبه") or
text:match("شرموطه") or
text:match("منيوك") or
text:match("عيوره") or
text:match("ها الو العيوره") or
text:match("كسخالتك") or text:match("كسمك") or text:match("عير")) and not msg.Distinguished then 
...
Redis:set(LKJHG.."LKJHG:Lock:farsia"..msg_chat_id,true) 
LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(msg.sender.user_id,"⌔︙تم قفـل الكفران").Lock,"md",true)  
return false
end 
...
Redis:del(LKJHG.."LKJHG:Lock:farsia"..msg_chat_id)  
LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(msg.sender.user_id,"⌔︙تم فتح الكفران").unLock,"md",true)  
return false
end 
if text and (text:match("خرب الله") or text:match("خربالله") or 
text:match("خرب محمد") or
text:match("خرب دينك") or
text:match("عير بربك") or text:match("كسربك") or text:match(" كس ربك")) and not msg.Distinguished then 
local phshar_Group = Redis:get(LKJHG.."LKJHG:Lock:farsia"..msg_chat_id)
if phshar_Group then
return LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
end
...
Redis:set(LKJHG.."LKJHG:Lock:text"..msg_chat_id,true) 
...
Redis:set(LKJHG.."LKJHG:Lock:AddMempar"..msg_chat_id,"kick")  
...
Redis:set(LKJHG.."LKJHG:Lock:Join"..msg_chat_id,"kick")  
...
Redis:set(LKJHG.."LKJHG:Lock:Bot:kick"..msg_chat_id,"del")  
...
Redis:set(LKJHG.."LKJHG:Lock:Bot:kick"..msg_chat_id,"kick")  
...
Redis:set(LKJHG.."LKJHG:Lock:tagservr"..msg_chat_id,true)  
...
Redis:set(LKJHG.."LKJHG:lockpin"..msg_chat_id,(LuaTele.getChatPinnedMessage(msg_chat_id).id or true)) 
...
Redis:set(LKJHG.."LKJHG:Lock:edit"..msg_chat_id,true) 
...
Redis:set(LKJHG.."LKJHG:Lock:tagservrbot"..msg_chat_id,true)   
list ={"Lock:Bot:kick","Lock:User:Name","Lock:hashtak","Lock:Cmd","Lock:Link","Lock:forward","Lock:Keyboard","Lock:geam","Lock:Photo","Lock:Animation","Lock:Video","Lock:Audio","Lock:vico","Lock:Sticker","Lock:Document","Lock:Unsupported","Lock:Markdaun","Lock:Contact","Lock:Spam"}
for i,lock in pairs(list) do 
Redis:set(LKJHG..'LKJHG:'..lock..msg_chat_id,"del")    
end
...
Redis:del(LKJHG.."LKJHG:Lock:AddMempar"..msg_chat_id)  
...
Redis:del(LKJHG.."LKJHG:Lock:text"..msg_chat_id)  
...
Redis:del(LKJHG.."LKJHG:Lock:Join"..msg_chat_id)  
...
Redis:del(LKJHG.."LKJHG:Lock:Bot:kick"..msg_chat_id)  
...
Redis:del(LKJHG.."LKJHG:Lock:tagservr"..msg_chat_id)  
...
Redis:del(LKJHG.."LKJHG:lockpin"..msg_chat_id)  
...
Redis:del(LKJHG.."LKJHG:Lock:edit"..msg_chat_id) 
...
Redis:del(LKJHG.."LKJHG:Lock:tagservrbot"..msg_chat_id)   
list ={"Lock:Bot:kick","Lock:User:Name","Lock:hashtak","Lock:Cmd","Lock:Link","Lock:forward","Lock:Keyboard","Lock:geam","Lock:Photo","Lock:Animation","Lock:Video","Lock:Audio","Lock:vico","Lock:Sticker","Lock:Document","Lock:Unsupported","Lock:Markdaun","Lock:Contact","Lock:Spam"}
for i,lock in pairs(list) do 
Redis:del(LKJHG..'LKJHG:'..lock..msg_chat_id)    
end
...
Redis:hset(LKJHG.."LKJHG:Spam:Group:User"..msg_chat_id ,"Spam:User","del")  
...
Redis:hset(LKJHG.."LKJHG:Spam:Group:User"..msg_chat_id ,"Spam:User","keed")  
...
Redis:hset(LKJHG.."LKJHG:Spam:Group:User"..msg_chat_id ,"Spam:User","mute")  
...
Redis:hset(LKJHG.."LKJHG:Spam:Group:User"..msg_chat_id ,"Spam:User","kick")  
...
Redis:hdel(LKJHG.."LKJHG:Spam:Group:User"..msg_chat_id ,"Spam:User")  
...
Redis:set(LKJHG.."LKJHG:Lock:Link"..msg_chat_id,"del")  
...
Redis:set(LKJHG.."LKJHG:Lock:Link"..msg_chat_id,"ked")  
...
Redis:set(LKJHG.."LKJHG:Lock:Link"..msg_chat_id,"ktm")  
...
Redis:set(LKJHG.."LKJHG:Lock:Link"..msg_chat_id,"kick")  
...
Redis:del(LKJHG.."LKJHG:Lock:Link"..msg_chat_id)  
...
Redis:set(LKJHG.."LKJHG:Lock:User:Name"..msg_chat_id,"del")  
...
Redis:set(LKJHG.."LKJHG:Lock:User:Name"..msg_chat_id,"ked")  
...
Redis:set(LKJHG.."LKJHG:Lock:User:Name"..msg_chat_id,"ktm")  
...
Redis:set(LKJHG.."LKJHG:Lock:User:Name"..msg_chat_id,"kick")  
...
Redis:del(LKJHG.."LKJHG:Lock:User:Name"..msg_chat_id)  
...
Redis:set(LKJHG.."LKJHG:Lock:hashtak"..msg_chat_id,"del")  
...
Redis:set(LKJHG.."LKJHG:Lock:hashtak"..msg_chat_id,"ked")  
...
Redis:set(LKJHG.."LKJHG:Lock:hashtak"..msg_chat_id,"ktm")  
...
Redis:set(LKJHG.."LKJHG:Lock:hashtak"..msg_chat_id,"kick")  
...
Redis:del(LKJHG.."LKJHG:Lock:hashtak"..msg_chat_id)  
...
Redis:set(LKJHG.."LKJHG:Lock:Cmd"..msg_chat_id,"del")  
...
Redis:set(LKJHG.."LKJHG:Lock:Cmd"..msg_chat_id,"ked")  
...
Redis:set(LKJHG.."LKJHG:Lock:Cmd"..msg_chat_id,"ktm")  
...
Redis:set(LKJHG.."LKJHG:Lock:Cmd"..msg_chat_id,"kick")  
...
Redis:del(LKJHG.."LKJHG:Lock:Cmd"..msg_chat_id)  
...
Redis:set(LKJHG.."LKJHG:Lock:Photo"..msg_chat_id,"del")  
...
Redis:set(LKJHG.."LKJHG:Lock:Photo"..msg_chat_id,"ked")  
...
Redis:set(LKJHG.."LKJHG:Lock:Photo"..msg_chat_id,"ktm")  
...
Redis:set(LKJHG.."LKJHG:Lock:Photo"..msg_chat_id,"kick")  
...
Redis:del(LKJHG.."LKJHG:Lock:Photo"..msg_chat_id)  
...
Redis:set(LKJHG.."LKJHG:Lock:Video"..msg_chat_id,"del")  
...
Redis:set(LKJHG.."LKJHG:Lock:Video"..msg_chat_id,"ked")  
...
Redis:set(LKJHG.."LKJHG:Lock:Video"..msg_chat_id,"ktm")  
...
Redis:set(LKJHG.."LKJHG:Lock:Video"..msg_chat_id,"kick")  
...
Redis:del(LKJHG.."LKJHG:Lock:Video"..msg_chat_id)  
...
Redis:set(LKJHG.."LKJHG:Lock:Animation"..msg_chat_id,"del")  
...
Redis:set(LKJHG.."LKJHG:Lock:Animation"..msg_chat_id,"ked")  
...
Redis:set(LKJHG.."LKJHG:Lock:Animation"..msg_chat_id,"ktm")  
...
Redis:set(LKJHG.."LKJHG:Lock:Animation"..msg_chat_id,"kick")  
...
Redis:del(LKJHG.."LKJHG:Lock:Animation"..msg_chat_id)  
...
Redis:set(LKJHG.."LKJHG:Lock:geam"..msg_chat_id,"del")  
...
Redis:set(LKJHG.."LKJHG:Lock:geam"..msg_chat_id,"ked")  
...
Redis:set(LKJHG.."LKJHG:Lock:geam"..msg_chat_id,"ktm")  
...
Redis:set(LKJHG.."LKJHG:Lock:geam"..msg_chat_id,"kick")  
...
Redis:del(LKJHG.."LKJHG:Lock:geam"..msg_chat_id)  
...
Redis:set(LKJHG.."LKJHG:Lock:Audio"..msg_chat_id,"del")  
...
Redis:set(LKJHG.."LKJHG:Lock:Audio"..msg_chat_id,"ked")  
...
Redis:set(LKJHG.."LKJHG:Lock:Audio"..msg_chat_id,"ktm")  
...
Redis:set(LKJHG.."LKJHG:Lock:Audio"..msg_chat_id,"kick")  
...
Redis:del(LKJHG.."LKJHG:Lock:Audio"..msg_chat_id)  
...
Redis:set(LKJHG.."LKJHG:Lock:vico"..msg_chat_id,"del")  
...
Redis:set(LKJHG.."LKJHG:Lock:vico"..msg_chat_id,"ked")  
...
Redis:set(LKJHG.."LKJHG:Lock:vico"..msg_chat_id,"ktm")  
...
Redis:set(LKJHG.."LKJHG:Lock:vico"..msg_chat_id,"kick")  
...
Redis:del(LKJHG.."LKJHG:Lock:vico"..msg_chat_id)  
...
Redis:set(LKJHG.."LKJHG:Lock:Keyboard"..msg_chat_id,"del")  
...
Redis:set(LKJHG.."LKJHG:Lock:Keyboard"..msg_chat_id,"ked")  
...
Redis:set(LKJHG.."LKJHG:Lock:Keyboard"..msg_chat_id,"ktm")  
...
Redis:set(LKJHG.."LKJHG:Lock:Keyboard"..msg_chat_id,"kick")  
...
Redis:del(LKJHG.."LKJHG:Lock:Keyboard"..msg_chat_id)  
...
Redis:set(LKJHG.."LKJHG:Lock:Sticker"..msg_chat_id,"del")  
...
Redis:set(LKJHG.."LKJHG:Lock:Sticker"..msg_chat_id,"ked")  
...
Redis:set(LKJHG.."LKJHG:Lock:Sticker"..msg_chat_id,"ktm")  
...
Redis:set(LKJHG.."LKJHG:Lock:Sticker"..msg_chat_id,"kick")  
...
Redis:del(LKJHG.."LKJHG:Lock:Sticker"..msg_chat_id)  
...
Redis:set(LKJHG.."LKJHG:Lock:forward"..msg_chat_id,"del")  
...
Redis:set(LKJHG.."LKJHG:Lock:forward"..msg_chat_id,"ked")  
...
Redis:set(LKJHG.."LKJHG:Lock:forward"..msg_chat_id,"ktm")  
...
Redis:set(LKJHG.."LKJHG:Lock:forward"..msg_chat_id,"kick")  
...
Redis:del(LKJHG.."LKJHG:Lock:forward"..msg_chat_id)  
...
Redis:set(LKJHG.."LKJHG:Lock:Document"..msg_chat_id,"del")  
...
Redis:set(LKJHG.."LKJHG:Lock:Document"..msg_chat_id,"ked")  
...
Redis:set(LKJHG.."LKJHG:Lock:Document"..msg_chat_id,"ktm")  
...
Redis:set(LKJHG.."LKJHG:Lock:Document"..msg_chat_id,"kick")  
...
Redis:del(LKJHG.."LKJHG:Lock:Document"..msg_chat_id)  
...
Redis:set(LKJHG.."LKJHG:Lock:Unsupported"..msg_chat_id,"del")  
...
Redis:set(LKJHG.."LKJHG:Lock:Unsupported"..msg_chat_id,"ked")  
...
Redis:set(LKJHG.."LKJHG:Lock:Unsupported"..msg_chat_id,"ktm")  
...
Redis:set(LKJHG.."LKJHG:Lock:Unsupported"..msg_chat_id,"kick")  
...
Redis:del(LKJHG.."LKJHG:Lock:Unsupported"..msg_chat_id)  
...
Redis:set(LKJHG.."LKJHG:Lock:Markdaun"..msg_chat_id,"del")  
...
Redis:set(LKJHG.."LKJHG:Lock:Markdaun"..msg_chat_id,"ked")  
...
Redis:set(LKJHG.."LKJHG:Lock:Markdaun"..msg_chat_id,"ktm")  
...
Redis:set(LKJHG.."LKJHG:Lock:Markdaun"..msg_chat_id,"kick")  
...
Redis:del(LKJHG.."LKJHG:Lock:Markdaun"..msg_chat_id)  
...
Redis:set(LKJHG.."LKJHG:Lock:Contact"..msg_chat_id,"del")  
...
Redis:set(LKJHG.."LKJHG:Lock:Contact"..msg_chat_id,"ked")  
...
Redis:set(LKJHG.."LKJHG:Lock:Contact"..msg_chat_id,"ktm")  
...
Redis:set(LKJHG.."LKJHG:Lock:Contact"..msg_chat_id,"kick")  
...
Redis:del(LKJHG.."LKJHG:Lock:Contact"..msg_chat_id)  
...
Redis:set(LKJHG.."LKJHG:Lock:Spam"..msg_chat_id,"del")  
...
Redis:set(LKJHG.."LKJHG:Lock:Spam"..msg_chat_id,"ked")  
...
Redis:set(LKJHG.."LKJHG:Lock:Spam"..msg_chat_id,"ktm")  
...
Redis:set(LKJHG.."LKJHG:Lock:Spam"..msg_chat_id,"kick")  
...
Redis:del(LKJHG.."LKJHG:Lock:Spam"..msg_chat_id)  
...
Redis:set(LKJHG.."LKJHG:Lock:Inlen"..msg_chat_id,"del")  
...
Redis:set(LKJHG.."LKJHG:Lock:Inlen"..msg_chat_id,"ked")  
...
Redis:set(LKJHG.."LKJHG:Lock:Inlen"..msg_chat_id,"ktm")  
...
Redis:set(LKJHG.."LKJHG:Lock:Inlen"..msg_chat_id,"kick")  
...
Redis:del(LKJHG.."LKJHG:Lock:Inlen"..msg_chat_id)  
...
Redis:setex(LKJHG.."LKJHG:Set:Link"..msg_chat_id..""..msg.sender.user_id,120,true) 
...
Redis:del(LKJHG.."LKJHG:Group:Link"..msg_chat_id) 
return LuaTele.sendText(msg_chat_id,msg_id,"⌔︙تم مسح الرابط ","md",true)             
end
if text == "الرابط" then
if not Redis:get(LKJHG.."LKJHG:Status:Link"..msg_chat_id) then
return LuaTele.sendText(msg_chat_id,msg_id,"⌔︙تم تعطيل جلب الرابط من قبل الادمنيه","md",true)
end 
local Get_Chat = LuaTele.getChat(msg_chat_id)
local GetLink = Redis:get(LKJHG.."LKJHG:Group:Link"..msg_chat_id) 
if GetLink then
...
if not Redis:get(LKJHG.."LKJHG:Status:Welcome"..msg_chat_id) then
...
Redis:del(LKJHG.."LKJHG:Welcome:Group"..msg_chat_id) 
...
Redis:setex(LKJHG.."LKJHG:Set:Rules:" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
...
Redis:del(LKJHG.."LKJHG:Group:Rules"..msg_chat_id) 
return LuaTele.sendText(msg_chat_id,msg_id,"⌔︙تم ازالة قوانين المجموعه","md",true)    
end
if text == "القوانين" then 
local Rules = Redis:get(LKJHG.."LKJHG:Group:Rules" .. msg_chat_id)   
if Rules then     
...
Redis:setex(LKJHG.."LKJHG:Set:Description:" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
...
Redis:set(LKJHG.."LKJHG:Chat:Photo"..msg_chat_id..":"..msg.sender.user_id,true) 
...
local list = Redis:smembers(LKJHG.."LKJHG:List:Filter"..msg_chat_id)  
if #list == 0 then  
...
v = v:gsub('animation:',"") 
v = v:gsub('text:',"") 
Redis:del(LKJHG.."LKJHG:Filter:Group:"..v..msg_chat_id)  
Redis:srem(LKJHG.."LKJHG:List:Filter"..msg_chat_id,v)  
end  
...
v = v:gsub('animation:',"") 
v = v:gsub('text:',"") 
local Text_Filter = Redis:get(LKJHG.."LKJHG:Filter:Group:"..v..msg_chat_id)   
...
Redis:set(LKJHG..'LKJHG:FilterText'..msg_chat_id..':'..msg.sender.user_id,'true')
...
Redis:set(LKJHG..'LKJHG:FilterText'..msg_chat_id..':'..msg.sender.user_id,'DelFilter')
return LuaTele.sendText(msg_chat_id,msg_id,'\n*⌔︙ارسل الان { ملصق ,متحركه ,صوره ,رساله } *',"md",true)  
end
...
Redis:set(LKJHG.."LKJHG:Command:Reids:Group"..msg_chat_id..":"..msg.sender.user_id,"true") 
...
Redis:set(LKJHG.."LKJHG:Command:Reids:Group:Del"..msg_chat_id..":"..msg.sender.user_id,"true") 
...
local list = Redis:smembers(LKJHG.."LKJHG:Command:List:Group"..msg_chat_id)
for k,v in pairs(list) do
Redis:del(LKJHG.."LKJHG:Get:Reides:Commands:Group"..msg_chat_id..":"..v)
Redis:del(LKJHG.."LKJHG:Command:List:Group"..msg_chat_id)
end
...
for k,v in pairs(list) do
Commands = Redis:get(LKJHG.."LKJHG:Get:Reides:Commands:Group"..msg_chat_id..":"..v)
if Commands then 
...
if Redis:get(LKJHG.."LKJHG:Status:Link"..msg.chat_id) then
Statuslink = '❬ ✔️ ❭' else Statuslink = '❬ ❌ ❭'
end
if Redis:get(LKJHG.."LKJHG:Status:Welcome"..msg.chat_id) then
StatusWelcome = '❬ ✔️ ❭' else StatusWelcome = '❬ ❌ ❭'
end
if Redis:get(LKJHG.."LKJHG:Status:Id"..msg.chat_id) then
StatusId = '❬ ✔️ ❭' else StatusId = '❬ ❌ ❭'
end
if Redis:get(LKJHG.."LKJHG:Status:IdPhoto"..msg.chat_id) then
StatusIdPhoto = '❬ ✔️ ❭' else StatusIdPhoto = '❬ ❌ ❭'
end
if Redis:get(LKJHG.."LKJHG:Status:Reply"..msg.chat_id) then
StatusReply = '❬ ✔️ ❭' else StatusReply = '❬ ❌ ❭'
end
if Redis:get(LKJHG.."LKJHG:Status:ReplySudo"..msg.chat_id) then
StatusReplySudo = '❬ ✔️ ❭' else StatusReplySudo = '❬ ❌ ❭'
end
if Redis:get(LKJHG.."LKJHG:Status:BanId"..msg.chat_id)  then
StatusBanId = '❬ ✔️ ❭' else StatusBanId = '❬ ❌ ❭'
end
if Redis:get(LKJHG.."LKJHG:Status:SetId"..msg.chat_id) then
StatusSetId = '❬ ✔️ ❭' else StatusSetId = '❬ ❌ ❭'
end
if Redis:get(LKJHG.."LKJHG:Status:Games"..msg.chat_id) then
StatusGames = '❬ ✔️ ❭' else StatusGames = '❬ ❌ ❭'
end
if Redis:get(LKJHG.."LKJHG:Status:KickMe"..msg.chat_id) then
Statuskickme = '❬ ✔️ ❭' else Statuskickme = '❬ ❌ ❭'
end
if Redis:get(LKJHG.."LKJHG:Status:AddMe"..msg.chat_id) then
...
Rink = 1
elseif Redis:sismember(LKJHG.."LKJHG:Developers:Groups",Message_Reply.sender.user_id)  then
Rink = 2
elseif Redis:sismember(LKJHG.."LKJHG:TheBasics:Group"..msg_chat_id, Message_Reply.sender.user_id) then
Rink = 3
elseif Redis:sismember(LKJHG.."LKJHG:Originators:Group"..msg_chat_id, Message_Reply.sender.user_id) then
Rink = 4
elseif Redis:sismember(LKJHG.."LKJHG:Managers:Group"..msg_chat_id, Message_Reply.sender.user_id) then
Rink = 5
elseif Redis:sismember(LKJHG.."LKJHG:Addictive:Group"..msg_chat_id, Message_Reply.sender.user_id) then
Rink = 6
elseif Redis:sismember(LKJHG.."LKJHG:Distinguished:Group"..msg_chat_id, Message_Reply.sender.user_id) then
Rink = 7
else
Rink = 8
end
...
Rink = 1
elseif Redis:sismember(LKJHG.."LKJHG:Developers:Groups",UserId_Info.id)  then
Rink = 2
elseif Redis:sismember(LKJHG.."LKJHG:TheBasics:Group"..msg_chat_id, UserId_Info.id) then
Rink = 3
elseif Redis:sismember(LKJHG.."LKJHG:Originators:Group"..msg_chat_id, UserId_Info.id) then
Rink = 4
elseif Redis:sismember(LKJHG.."LKJHG:Managers:Group"..msg_chat_id, UserId_Info.id) then
Rink = 5
elseif Redis:sismember(LKJHG.."LKJHG:Addictive:Group"..msg_chat_id, UserId_Info.id) then
Rink = 6
elseif Redis:sismember(LKJHG.."LKJHG:Distinguished:Group"..msg_chat_id, UserId_Info.id) then
Rink = 7
else
Rink = 8
end
...
Redis:del(LKJHG..'LKJHG:Num:Message:User'..msg.chat_id..':'..msg.sender.user_id)
LuaTele.sendText(msg_chat_id,msg_id,'⌔︙تم مسح جميع رسائلك ',"md",true)  
elseif text == 'مسح سحكاتي' or text == 'مسح تعديلاتي' then
Redis:del(LKJHG..'LKJHG:Num:Message:Edit'..msg.chat_id..':'..msg.sender.user_id)
LuaTele.sendText(msg_chat_id,msg_id,'⌔︙تم مسح جميع تعديلاتك ',"md",true)  
elseif text == 'مسح جهاتي' then
Redis:del(LKJHG..'LKJHG:Num:Add:Memp'..msg.chat_id..':'..msg.sender.user_id)
LuaTele.sendText(msg_chat_id,msg_id,'⌔︙تم مسح جميع جهاتك المضافه ',"md",true)  
elseif text == 'رسائلي' then
LuaTele.sendText(msg_chat_id,msg_id,'⌔︙عدد رسائلك هنا *~ '..(Redis:get(LKJHG..'LKJHG:Num:Message:User'..msg.chat_id..':'..msg.sender.user_id) or 1)..'*',"md",true)  
elseif text == 'سحكاتي' or text == 'تعديلاتي' then
LuaTele.sendText(msg_chat_id,msg_id,'⌔︙عدد التعديلات هنا *~ '..(Redis:get(LKJHG..'LKJHG:Num:Message:Edit'..msg.chat_id..msg.sender.user_id) or 0)..'*',"md",true)  
elseif text == 'جهاتي' then
LuaTele.sendText(msg_chat_id,msg_id,'⌔︙عدد جهاتك المضافه هنا *~ '..(Redis:get(LKJHG.."LKJHG:Num:Add:Memp"..msg.chat_id..":"..msg.sender.user_id) or 0)..'*',"md",true)  
...
Redis:setex(LKJHG.."LKJHG:Redis:Id:Group"..msg.chat_id..""..msg.sender.user_id,240,true)  
return LuaTele.sendText(msg_chat_id,msg_id,[[
⌔︙ارسل الان النص
⌔︙يمكنك اضافه :
...
Redis:del(LKJHG.."LKJHG:Set:Id:Group"..msg.chat_id)
...
return https.request("https://api.telegram.org/bot"..Token.."/sendVoice?chat_id="..msg.chat_id.."&voice=https://t.me/MMMMSY/"..math.random(3,337).."&caption="..URL.escape("⌔ تم اختيار الاغنيه لك").."&reply_to_message_id="..msgg.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
end
...
local msgg = msg.id/2097152/0.5 
return https.request("https://api.telegram.org/bot"..Token.."/sendVoice?chat_id="..msg.chat_id.."&voice=https://t.me/AlexBesso/"..math.random(3,206).."&caption="..URL.escape("⌔ تم اختيار الشعر لك").."&reply_to_message_id="..msgg.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end 
end
...
Redis:del(LKJHG.."LKJHG:DevelopersQ:Groups") 
...
Redis:del(LKJHG.."LKJHG:Developers:Groups") 
...
Redis:del(LKJHG.."LKJHG:TheBasics:Group"..msg_chat_id) 
...
Redis:del(LKJHG.."LKJHG:Originators:Group"..msg_chat_id) 
...
Redis:del(LKJHG.."LKJHG:Managers:Group"..msg_chat_id) 
...
Redis:del(LKJHG.."LKJHG:Addictive:Group"..msg_chat_id) 
...
Redis:del(LKJHG.."LKJHG:Distinguished:Group"..msg_chat_id) 
...
Redis:del(LKJHG.."LKJHG:BanAll:Groups") 
...
Redis:del(LKJHG.."LKJHG:BanGroup:Group"..msg_chat_id) 
...
Redis:del(LKJHG.."LKJHG:SilentGroup:Group"..msg_chat_id) 
...
local list = Redis:smembers(LKJHG.."LKJHG:List:Manager"..msg_chat_id.."")
for k,v in pairs(list) do
Redis:del(LKJHG.."LKJHG:Add:Rd:Manager:Gif"..v..msg_chat_id)   
Redis:del(LKJHG.."LKJHG:Add:Rd:Manager:Vico"..v..msg_chat_id)   
Redis:del(LKJHG.."LKJHG:Add:Rd:Manager:Stekrs"..v..msg_chat_id)     
Redis:del(LKJHG.."LKJHG:Add:Rd:Manager:Text"..v..msg_chat_id)   
Redis:del(LKJHG.."LKJHG:Add:Rd:Manager:Photo"..v..msg_chat_id)
Redis:del(LKJHG.."LKJHG:Add:Rd:Manager:Video"..v..msg_chat_id)
Redis:del(LKJHG.."LKJHG:Add:Rd:Manager:File"..v..msg_chat_id)
Redis:del(LKJHG.."LKJHG:Add:Rd:Manager:video_note"..v..msg_chat_id)
Redis:del(LKJHG.."LKJHG:Add:Rd:Manager:Audio"..v..msg_chat_id)
Redis:del(LKJHG.."LKJHG:List:Manager"..msg_chat_id)
end
...
for k,v in pairs(list) do
if Redis:get(LKJHG.."LKJHG:Add:Rd:Manager:Gif"..v..msg_chat_id) then
db = "متحركه 🎭"
elseif Redis:get(LKJHG.."LKJHG:Add:Rd:Manager:Vico"..v..msg_chat_id) then
db = "بصمه 📢"
elseif Redis:get(LKJHG.."LKJHG:Add:Rd:Manager:Stekrs"..v..msg_chat_id) then
db = "ملصق 🃏"
elseif Redis:get(LKJHG.."LKJHG:Add:Rd:Manager:Text"..v..msg_chat_id) then
db = "رساله ✉"
elseif Redis:get(LKJHG.."LKJHG:Add:Rd:Manager:Photo"..v..msg_chat_id) then
db = "صوره 🎇"
elseif Redis:get(LKJHG.."LKJHG:Add:Rd:Manager:Video"..v..msg_chat_id) then
db = "فيديو 📹"
elseif Redis:get(LKJHG.."LKJHG:Add:Rd:Manager:File"..v..msg_chat_id) then
db = "ملف ⌔"
elseif Redis:get(LKJHG.."LKJHG:Add:Rd:Manager:Audio"..v..msg_chat_id) then
db = "اغنيه 🎵"
elseif Redis:get(LKJHG.."LKJHG:Add:Rd:Manager:video_note"..v..msg_chat_id) then
db = "بصمه فيديو 🎥"
end
text = text..""..k.." » {"..v.."} » {"..db.."}\n"
end
...
Redis:set(LKJHG.."LKJHG:Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id,true)
...
Redis:set(LKJHG.."LKJHG:Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id,"true2")
...
local list = Redis:smembers(LKJHG.."LKJHG:List:Rd:Sudo")
for k,v in pairs(list) do
Redis:del(LKJHG.."LKJHG:Add:Rd:Sudo:Gif"..v)   
Redis:del(LKJHG.."LKJHG:Add:Rd:Sudo:vico"..v)   
Redis:del(LKJHG.."LKJHG:Add:Rd:Sudo:stekr"..v)     
Redis:del(LKJHG.."LKJHG:Add:Rd:Sudo:Text"..v)   
Redis:del(LKJHG.."LKJHG:Add:Rd:Sudo:Photo"..v)
Redis:del(LKJHG.."LKJHG:Add:Rd:Sudo:Video"..v)
Redis:del(LKJHG.."LKJHG:Add:Rd:Sudo:File"..v)
Redis:del(LKJHG.."LKJHG:Add:Rd:Sudo:Audio"..v)
Redis:del(LKJHG.."LKJHG:Add:Rd:Sudo:video_note"..v)
Redis:del(LKJHG.."LKJHG:List:Rd:Sudo")
end
...
text = "\n📝︙قائمة ردود المطور \n••┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉••\n"
for k,v in pairs(list) do
if Redis:get(LKJHG.."LKJHG:Add:Rd:Sudo:Gif"..v) then
db = "متحركه 🎭"
elseif Redis:get(LKJHG.."LKJHG:Add:Rd:Sudo:vico"..v) then
db = "بصمه 📢"
elseif Redis:get(LKJHG.."LKJHG:Add:Rd:Sudo:stekr"..v) then
db = "ملصق 🃏"
elseif Redis:get(LKJHG.."LKJHG:Add:Rd:Sudo:Text"..v) then
db = "رساله ✉"
elseif Redis:get(LKJHG.."LKJHG:Add:Rd:Sudo:Photo"..v) then
db = "صوره 🎇"
elseif Redis:get(LKJHG.."LKJHG:Add:Rd:Sudo:Video"..v) then
db = "فيديو 📹"
elseif Redis:get(LKJHG.."LKJHG:Add:Rd:Sudo:File"..v) then
db = "ملف ⌔"
elseif Redis:get(LKJHG.."LKJHG:Add:Rd:Sudo:Audio"..v) then
db = "اغنيه 🎵"
elseif Redis:get(LKJHG.."LKJHG:Add:Rd:Sudo:video_note"..v) then
db = "بصمه فيديو 🎥"
end
text = text..""..k.." » {"..v.."} » {"..db.."}\n"
end
...
Redis:set(LKJHG.."LKJHG:Set:Rd"..msg.sender.user_id..":"..msg_chat_id,true)
...
Redis:set(LKJHG.."LKJHG:Set:On"..msg.sender.user_id..":"..msg_chat_id,true)
...
Redis:setex(LKJHG.."LKJHG:Broadcasting:Users" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
LuaTele.sendText(msg_chat_id,msg_id,[[
↯︙ارسل لي سواء كان 
❨ ملف • ملصق • متحركه • صوره
 • فيديو • بصمه الفيديو • بصمه • صوت • رساله ❩
...
Redis:setex(LKJHG.."LKJHG:Broadcasting:Groups" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
LuaTele.sendText(msg_chat_id,msg_id,[[
↯︙ارسل لي سواء كان 
❨ ملف • ملصق • متحركه • صوره
 • فيديو • بصمه الفيديو • بصمه • صوت • رساله ❩
...
Redis:setex(LKJHG.."LKJHG:Broadcasting:Groups:Pin" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
LuaTele.sendText(msg_chat_id,msg_id,[[
↯︙ارسل لي سواء كان 
❨ ملف • ملصق • متحركه • صوره
 • فيديو • بصمه الفيديو • بصمه • صوت • رساله ❩
...
Redis:setex(LKJHG.."LKJHG:Broadcasting:Groups:Fwd" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
...
Redis:setex(LKJHG.."LKJHG:Broadcasting:Users:Fwd" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
...
Redis:set(LKJHG..'LKJHG:GetTexting:DevLKJHG'..msg_chat_id..':'..msg.sender.user_id,true)
...
Redis:setex(LKJHG.."LKJHG:Change:Name:Bot"..msg.sender.user_id,300,true) 
...
if text == (Redis:get(LKJHG.."LKJHG:Name:Bot") or "ليكس") then
...
x = x + 1
Redis:srem(LKJHG..'LKJHG:Num:User:Pv',v)
end
end
if x ~= 0 then
...
local Get_Chat = LuaTele.getChat(v)
if Get_Chat.id then
local statusMem = LuaTele.getChatMember(Get_Chat.id,LKJHG)
if statusMem.status.luatele == "chatMemberStatusMember" then
x = x + 1
LuaTele.sendText(Get_Chat.id,0,'*⌔︙البوت عظو في المجموعه سوف اغادر ويمكنك تفعيلي مره اخره *',"md")
Redis:srem(LKJHG..'LKJHG:ChekBotAdd',Get_Chat.id)
local keys = Redis:keys(LKJHG..'*'..Get_Chat.id)
for i = 1, #keys do
Redis:del(keys[i])
end
...
x = x + 1
local keys = Redis:keys(LKJHG..'*'..v)
for i = 1, #keys do
Redis:del(keys[i])
end
Redis:srem(LKJHG..'LKJHG:ChekBotAdd',v)
LuaTele.leaveChat(v)
end
end
if x ~= 0 then
...
Redis:set(LKJHG.."LKJHG:Status:Klam:engilsh"..msg.chat_id,name)
...
Redis:set(LKJHG.."LKJHG:Status:Klam:plus"..msg.chat_id,name)
...
Redis:set(LKJHG.."LKJHG:Game:Monotonous"..msg.chat_id,name)
...
Redis:set(LKJHG.."LKJHG:Game:Riddles"..msg.chat_id,name)
...
if text == "معاني" then
if Redis:get(LKJHG.."LKJHG:Status:Games"..msg.chat_id) then
Redis:del(LKJHG.."LKJHG:Set:Maany"..msg.chat_id)
Maany_Rand = {"قرد","دجاجه","بطريق","ضفدع","بومه","نحله","ديك","جمل","بقره","دولفين","تمساح","قرش","نمر","اخطبوط","سمكه","خفاش","اسد","فأر","ذئب","فراشه","عقرب","زرافه","قنفذ","تفاحه","باذنجان"}
name = Maany_Rand[math.random(#Maany_Rand)]
Redis:set(LKJHG.."LKJHG:Game:Meaningof"..msg.chat_id,name)
...
if text == "العكس" then
if Redis:get(LKJHG.."LKJHG:Status:Games"..msg.chat_id) then
Redis:del(LKJHG.."LKJHG:Set:Aks"..msg.chat_id)
katu = {"باي","فهمت","موزين","اسمعك","احبك","موحلو","نضيف","حاره","ناصي","جوه","سريع","ونسه","طويل","سمين","ضعيف","شريف","شجاع","رحت","عدل","نشيط","شبعان","موعطشان","خوش ولد","اني","هادئ"}
name = katu[math.random(#katu)]
Redis:set(LKJHG.."LKJHG:Game:Reflection"..msg.chat_id,name)
...
Redis:set(LKJHG.."LKJHG:Game:Estimate"..msg.chat_id..msg.sender.user_id,Num)  
...
Redis:set(LKJHG.."LKJHG:Game:Difference"..msg.chat_id,name)
...
Redis:set(LKJHG.."LKJHG:Game:Example"..msg.chat_id,name)
...
local NumberGame = Redis:get(LKJHG.."LKJHG:Num:Add:Games"..msg.chat_id..msg.sender.user_id)
...
Redis:decrby(LKJHG.."LKJHG:Num:Add:Games"..msg.chat_id..msg.sender.user_id,NumGame)  
Redis:incrby(LKJHG.."LKJHG:Num:Message:User"..msg.chat_id..":"..msg.sender.user_id,NumGame)  
...
Redis:incrby(LKJHG.."LKJHG:Num:Add:Games"..msg.chat_id..Message_Reply.sender.user_id, text:match("^اضف مجوهرات (%d+)$"))  
...
Redis:incrby(LKJHG.."LKJHG:Num:Message:User"..msg.chat_id..":"..Message_Reply.sender.user_id, text:match("^اضف رسائل (%d+)$"))  
...
local Num = Redis:get(LKJHG.."LKJHG:Num:Add:Games"..msg.chat_id..msg.sender.user_id) or 0
if Num == 0 then 
...
Redis:set(LKJHG.."LKJHG:Get:Reides:Commands:Group"..msg_chat_id..":"..'تعط','تعطيل الايدي بالصوره')
Redis:set(LKJHG.."LKJHG:Get:Reides:Commands:Group"..msg_chat_id..":"..'تفع','تفعيل الايدي بالصوره')
Redis:set(LKJHG.."LKJHG:Get:Reides:Commands:Group"..msg_chat_id..":"..'ا','ايدي')
Redis:set(LKJHG.."LKJHG:Get:Reides:Commands:Group"..msg_chat_id..":"..'م','رفع مميز')
Redis:set(LKJHG.."LKJHG:Get:Reides:Commands:Group"..msg_chat_id..":"..'اد', 'رفع ادمن')
...
return LuaTele.sendText(msg_chat_id,msg_id,Redis:get(LKJHG.."LKJHG:Start:Bot"),"md",false, false, false, false, reply_markup)
end
else
...
Redis:setex(LKJHG.."LKJHG:Change:Start:Bot"..msg.sender.user_id,300,true) 
...
Redis:del(LKJHG.."LKJHG:Start:Bot") 
...
if not msg.ControllerBot then
if Redis:get(LKJHG.."LKJHG:TwaslBot") and not Redis:sismember(LKJHG.."LKJHG:BaN:In:Tuasl",msg.sender.user_id) then
local ListGet = {Sudo_Id,msg.sender.user_id}
local IdSudo = LuaTele.getChat(ListGet[1]).id
local IdUser = LuaTele.getChat(ListGet[2]).id
local FedMsg = LuaTele.sendForwarded(IdSudo, 0, IdUser, msg_id)
Redis:setex(LKJHG.."LKJHG:Twasl:UserId"..msg.date,172800,IdUser)
...
local Info_User = Redis:get(LKJHG.."LKJHG:Twasl:UserId"..Message_Get.forward_info.date) or 46899864
if text == 'حظر' then
Redis:sadd(LKJHG..'LKJHG:BaN:In:Tuasl',Info_User)  
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Info_User,'⌔︙تم حظره من تواصل البوت ').Reply,"md",true)  
end 
if text =='الغاء الحظر' or text =='الغاء حظر' then
Redis:srem(LKJHG..'LKJHG:BaN:In:Tuasl',Info_User)  
...
Redis:srem(LKJHG.."LKJHG:ChekBotAdd",'-100'..data.supergroup.id)
local keys = Redis:keys(LKJHG..'*'..'-100'..data.supergroup.id)
for i = 1, #keys do
Redis:del(keys[i])
end
...
if msg.content.video_note then
if msg.content.video_note.video.remote.id == Redis:get(LKJHG.."LKJHG:PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(LKJHG.."LKJHG:PinMsegees:"..msg.chat_id)
end
elseif msg.content.photo then
if msg.content.photo.sizes[1].photo.remote.id then
idPhoto = msg.content.photo.sizes[1].photo.remote.id
...
if idPhoto == Redis:get(LKJHG.."LKJHG:PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(LKJHG.."LKJHG:PinMsegees:"..msg.chat_id)
end
elseif msg.content.sticker then 
if msg.content.sticker.sticker.remote.id == Redis:get(LKJHG.."LKJHG:PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(LKJHG.."LKJHG:PinMsegees:"..msg.chat_id)
end
elseif msg.content.voice_note then 
if msg.content.voice_note.voice.remote.id == Redis:get(LKJHG.."LKJHG:PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(LKJHG.."LKJHG:PinMsegees:"..msg.chat_id)
end
elseif msg.content.video then 
if msg.content.video.video.remote.id == Redis:get(LKJHG.."LKJHG:PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(LKJHG.."LKJHG:PinMsegees:"..msg.chat_id)
end
elseif msg.content.animation then 
if msg.content.animation.animation.remote.id ==  Redis:get(LKJHG.."LKJHG:PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(LKJHG.."LKJHG:PinMsegees:"..msg.chat_id)
end
elseif msg.content.document then
if msg.content.document.document.remote.id == Redis:get(LKJHG.."LKJHG:PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(LKJHG.."LKJHG:PinMsegees:"..msg.chat_id)
end
elseif msg.content.audio then
if msg.content.audio.audio.remote.id == Redis:get(LKJHG.."LKJHG:PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(LKJHG.."LKJHG:PinMsegees:"..msg.chat_id)
end
elseif text then
if text == Redis:get(LKJHG.."LKJHG:PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(LKJHG.."LKJHG:PinMsegees:"..msg.chat_id)
end
end
...
if Redis:get(LKJHG.."LKJHG:Lock:tagservr"..data.message.chat_id) then
LuaTele.deleteMessages(data.message.chat_id,{[1]= data.message.id})
end
end 
if tonumber(data.message.sender.user_id) == tonumber(LKJHG) then
return false
end
...
if Message_Edit.sender.user_id == LKJHG then
print('This is Edit for Bot')
return false
end
File_Bot_Run(Message_Edit,Message_Edit)
Redis:incr(LKJHG..'LKJHG:Num:Message:Edit'..data.chat_id..Message_Edit.sender.user_id)
if Message_Edit.content.luatele == "messageContact" or Message_Edit.content.luatele == "messageVideoNote" or Message_Edit.content.luatele == "messageDocument" or Message_Edit.content.luatele == "messageAudio" or Message_Edit.content.luatele == "messageVideo" or Message_Edit.content.luatele == "messageVoiceNote" or Message_Edit.content.luatele == "messageAnimation" or Message_Edit.content.luatele == "messagePhoto" then
if Redis:get(LKJHG.."LKJHG:Lock:edit"..data.chat_id) then
...
Redis:incrby(LKJHG.."LKJHG:Num:Add:Games"..ChatId..IdUser, 1)  
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(LKJHG.."LKJHG:Lock:Link"..ChatId,"del")  
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(LKJHG.."LKJHG:Lock:Spam"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(LKJHG.."LKJHG:Lock:Keyboard"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(LKJHG.."LKJHG:Lock:vico"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(LKJHG.."LKJHG:Lock:Animation"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(LKJHG.."LKJHG:Lock:Document"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(LKJHG.."LKJHG:Lock:text"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(LKJHG.."LKJHG:Lock:Video"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(LKJHG.."LKJHG:Lock:Photo"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(LKJHG.."LKJHG:Lock:User:Name"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(LKJHG.."LKJHG:Lock:hashtak"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(LKJHG.."LKJHG:Lock:Bot:kick"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(LKJHG.."LKJHG:Lock:forward"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(LKJHG.."LKJHG:Lock:Audio"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(LKJHG.."LKJHG:Lock:Sticker"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(LKJHG.."LKJHG:Lock:Contact"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(LKJHG.."LKJHG:Lock:Join"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(LKJHG.."LKJHG:Lock:AddMempar"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(LKJHG.."LKJHG:Lock:Unsupported"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(LKJHG.."LKJHG:lockpin"..ChatId,(LuaTele.getChatPinnedMessage(ChatId).id or true)) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(LKJHG.."LKJHG:Lock:tagservr"..ChatId,true)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(LKJHG.."LKJHG:Lock:Markdaun"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(LKJHG.."LKJHG:Lock:edit"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(LKJHG.."LKJHG:Lock:geam"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:hset(LKJHG.."LKJHG:Spam:Group:User"..ChatId ,"Spam:User","del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(LKJHG.."LKJHG:Lock:Link"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(LKJHG.."LKJHG:Lock:Spam"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(LKJHG.."LKJHG:Lock:Keyboard"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(LKJHG.."LKJHG:Lock:vico"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(LKJHG.."LKJHG:Lock:Animation"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(LKJHG.."LKJHG:Lock:Document"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(LKJHG.."LKJHG:Lock:Video"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(LKJHG.."LKJHG:Lock:Photo"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(LKJHG.."LKJHG:Lock:User:Name"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(LKJHG.."LKJHG:Lock:hashtak"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(LKJHG.."LKJHG:Lock:forward"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(LKJHG.."LKJHG:Lock:Audio"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(LKJHG.."LKJHG:Lock:Sticker"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(LKJHG.."LKJHG:Lock:Contact"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(LKJHG.."LKJHG:Lock:Unsupported"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(LKJHG.."LKJHG:Lock:Markdaun"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(LKJHG.."LKJHG:Lock:geam"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:hset(LKJHG.."LKJHG:Spam:Group:User"..ChatId ,"Spam:User","keed")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(LKJHG.."LKJHG:Lock:Link"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(LKJHG.."LKJHG:Lock:Spam"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(LKJHG.."LKJHG:Lock:Keyboard"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(LKJHG.."LKJHG:Lock:vico"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(LKJHG.."LKJHG:Lock:Animation"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(LKJHG.."LKJHG:Lock:Document"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(LKJHG.."LKJHG:Lock:Video"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(LKJHG.."LKJHG:Lock:Photo"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(LKJHG.."LKJHG:Lock:User:Name"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(LKJHG.."LKJHG:Lock:hashtak"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(LKJHG.."LKJHG:Lock:forward"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(LKJHG.."LKJHG:Lock:Audio"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(LKJHG.."LKJHG:Lock:Sticker"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(LKJHG.."LKJHG:Lock:Contact"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(LKJHG.."LKJHG:Lock:Unsupported"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(LKJHG.."LKJHG:Lock:Markdaun"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(LKJHG.."LKJHG:Lock:geam"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:hset(LKJHG.."LKJHG:Spam:Group:User"..ChatId ,"Spam:User","mute")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(LKJHG.."LKJHG:Lock:Link"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(LKJHG.."LKJHG:Lock:Spam"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(LKJHG.."LKJHG:Lock:Keyboard"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(LKJHG.."LKJHG:Lock:vico"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(LKJHG.."LKJHG:Lock:Animation"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(LKJHG.."LKJHG:Lock:Document"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(LKJHG.."LKJHG:Lock:Video"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(LKJHG.."LKJHG:Lock:Photo"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(LKJHG.."LKJHG:Lock:User:Name"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(LKJHG.."LKJHG:Lock:hashtak"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(LKJHG.."LKJHG:Lock:forward"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(LKJHG.."LKJHG:Lock:Audio"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(LKJHG.."LKJHG:Lock:Sticker"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(LKJHG.."LKJHG:Lock:Contact"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(LKJHG.."LKJHG:Lock:Unsupported"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(LKJHG.."LKJHG:Lock:Markdaun"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(LKJHG.."LKJHG:Lock:geam"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:hset(LKJHG.."LKJHG:Spam:Group:User"..ChatId ,"Spam:User","kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(LKJHG.."LKJHG:Status:Link"..ChatId) 
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(LKJHG.."LKJHG:Status:Welcome"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(LKJHG.."LKJHG:Status:Id"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(LKJHG.."LKJHG:Status:IdPhoto"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(LKJHG.."LKJHG:Status:Reply"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(LKJHG.."LKJHG:Status:ReplySudo"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(LKJHG.."LKJHG:Status:SetId"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(LKJHG.."LKJHG:Status:BanId"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(LKJHG.."LKJHG:Status:Games"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(LKJHG.."LKJHG:Status:KickMe"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(LKJHG.."LKJHG:Status:Link"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(LKJHG.."LKJHG:Status:Welcome"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(LKJHG.."LKJHG:Status:Id"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(LKJHG.."LKJHG:Status:IdPhoto"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(LKJHG.."LKJHG:Status:Reply"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(LKJHG.."LKJHG:Status:ReplySudo"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(LKJHG.."LKJHG:Status:SetId"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(LKJHG.."LKJHG:Status:BanId"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(LKJHG.."LKJHG:Status:Games"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(LKJHG.."LKJHG:Status:KickMe"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if Info_Members.members[k].bot_info == nil then
if Info_Members.members[k].status.luatele == "chatMemberStatusCreator" then
Redis:sadd(LKJHG.."LKJHG:TheBasics:Group"..UserId[2],v.member_id.user_id) 
x = x + 1
else
Redis:sadd(LKJHG.."LKJHG:Addictive:Group"..UserId[2],v.member_id.user_id) 
y = y + 1
end
end
end
...
if tonumber(IdUser) == tonumber(UserId[1]) then
Redis:set(LKJHG.."LKJHG:Lock:tagservrbot"..UserId[2],true)   
list ={"Lock:Bot:kick","Lock:User:Name","Lock:hashtak","Lock:Cmd","Lock:Link","Lock:forward","Lock:Keyboard","Lock:geam","Lock:Photo","Lock:Animation","Lock:Video","Lock:Audio","Lock:vico","Lock:Sticker","Lock:Document","Lock:Unsupported","Lock:Markdaun","Lock:Contact","Lock:Spam"}
for i,lock in pairs(list) do 
Redis:set(LKJHG..'LKJHG:'..lock..UserId[2],"del")    
end
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(LKJHG.."LKJHG:Lock:Link"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(LKJHG.."LKJHG:Lock:Spam"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(LKJHG.."LKJHG:Lock:Keyboard"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(LKJHG.."LKJHG:Lock:vico"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(LKJHG.."LKJHG:Lock:Animation"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(LKJHG.."LKJHG:Lock:Document"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(LKJHG.."LKJHG:Lock:text"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(LKJHG.."LKJHG:Lock:Video"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(LKJHG.."LKJHG:Lock:Photo"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(LKJHG.."LKJHG:Lock:User:Name"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(LKJHG.."LKJHG:Lock:hashtak"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(LKJHG.."LKJHG:Lock:Bot:kick"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(LKJHG.."LKJHG:Lock:forward"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(LKJHG.."LKJHG:Lock:Audio"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(LKJHG.."LKJHG:Lock:Sticker"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(LKJHG.."LKJHG:Lock:Contact"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(LKJHG.."LKJHG:Lock:Join"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(LKJHG.."LKJHG:Lock:AddMempar"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(LKJHG.."LKJHG:Lock:Unsupported"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(LKJHG.."LKJHG:lockpin"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(LKJHG.."LKJHG:Lock:tagservr"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(LKJHG.."LKJHG:Lock:Markdaun"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(LKJHG.."LKJHG:Lock:edit"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(LKJHG.."LKJHG:Lock:geam"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:hdel(LKJHG.."LKJHG:Spam:Group:User"..ChatId ,"Spam:User")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(LKJHG.."LKJHG:TheBasics:Group"..ChatId) 
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(LKJHG.."LKJHG:Originators:Group"..ChatId) 
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(LKJHG.."LKJHG:Managers:Group"..ChatId) 
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(LKJHG.."LKJHG:Addictive:Group"..ChatId) 
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(LKJHG.."LKJHG:Distinguished:Group"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(LKJHG.."LKJHG:BanGroup:Group"..ChatId) 
LuaTele.editMessageText(ChatId,Msg_id,"⌔︙تم مسح المحظورين", 'md', false)
end
elseif Text and Text:match('(%d+)/SilentGroupGroup') then
local UserId = Text:match('(%d+)/SilentGroupGroup')
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(LKJHG.."LKJHG:SilentGroup:Group"..ChatId) 
